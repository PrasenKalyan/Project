                                                   ...
                                                   <th><?php echo $rs1['user']; ?></th>
                                                     <td class="hidden-480">
														...
														<?php }?>
                                                         ...
                                                         <td class="hidden-480"><a href="tnqotti_excel.php?id=<?php echo $rs1['quet_num']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
													<td class="hidden-480"><a href="tnqotti_pdf.php?id=<?php echo $rs1['quet_num']; ?>">
                                                         <img src="images/pdf_icon.gif" width="30" height="30"></a></td>
													<td class="hidden-480"><a href="tnqotbrk_excel.php?id=<?php echo $rs1['quet_num']; ?>">
                                                          <img src="images/xl.jpg" width="20" height="20"></a></td>
													   <td class="hidden-480"><a href="tnqotbrk_pdf.php?id=<?php echo $rs1['quet_num']; ?>">
                                                         <img src="images/pdf_icon.gif" width="30" height="30"></a></td>	

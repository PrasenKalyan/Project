...
<div class="row">
 ...
 <form name="frm" method="post" action="tgqot_suc1.php" enctype="multipart/form-data">
...
?>
										...
										<textarea  required name="falt_desc" readonly id="falt_no" class="form-control" <?php if($rono!=''){ echo 'readonly'; }else { echo '';} ?>><?php echo $r['falt_desc'];?></textarea></td>
                                        ...
                                        <td align="right">Sub Type</td><td><input type="text" name="sub_type" readonly

...
echo date('d-m-Y', strtotime($d)); }?></td>
                                                        ...
                                                        <td class="hidden-480">
                                                            ...
                                                            <a href="kledit_wip.php?id=<?php echo $rs1['quet_num']; ?>&id1=<?php echo $r1['id'];?>">
...
echo "<li><a href='klwip_list.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='klwip_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

...
$cgstamt=$_POST['cgstamt'][$i];
 ...
 $query = "INSERT INTO add_bill ( `service_no`, `item_code`, `price`, `qty`, `tax_amnt`, `gst_amnt`, `sgst`, `cgst`,`date`,`temp_type`,`uom`,`item_desc`,`sgstamount`,`cgstamount`,`sno`,`id1`,`hsnno`,`sacno`) 
	VALUES 
 ('$service_no','$item_code','$price','$qty','$amnt','$gst_amnt','$sgst','$cgst','$date','$temp','$uom','$item_desc','$sgstamt','$cgstamt','$lno','$lid','$hsn','$sac')";
 $res=mysqli_query($link,$query) or die(mysqli_error($link));
	...
	print "self.location='osinvoice.php?id=$service_no&loc=$loc&id1=$lid';";
	print "</script>";

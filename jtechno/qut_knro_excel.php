...
include 'PHPExcel-1.8/Classes/PHPExcel/Writer/Excel2007.php';
 $tsname=$_GET['user'];
$datatable="add_knqot";
	if(($tsname=='admin') or ($tsname=='durgarao')or ($tsname=='sumanthpotluri')or ($tsname=='rajesh.p')){
...
header('Content-Disposition: attachment;filename="knrorequired.xlsx"'); //tell browser what's the file name

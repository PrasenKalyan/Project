            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <?php $id=$_GET['id'];
						$sq=mysqli_query($link,"select * from approducts where id='$id'");
 ...
 <input type="hidden" name="id" value="<?php echo $id?>">
									   ...
									   <td align="right">Location</td><td align="left">
                                        ...
                                        <div class="col-md-offset-4 col-md-8">
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="andhrauploadproducts.php"><button class="btn btn-danger" type="button" name="button" id="Close">
                                        ...
                                        <?php if(isset($_POST['update'])){
											...
											$id=$_POST['id'];
											$sq=mysqli_query($link,"update approducts set `item_code`='$item_code',

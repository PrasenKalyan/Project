...
if ($sheet != null) {
    if ($sheet->removeRow($row_id, $number_rows)) {
        ...
        // Set the format of cells with numeric values in column F (rows 13 to 17) to TEXT format
$spreadsheet->getActiveSheet()->getStyle('F13:F17')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_TEXT);

...
if(isset($_POST['submit'])){
    ...
    $qt_no=$_POST['qt_no']; 
	$ssq=mysqli_query($link,"select * from  add_qot  where quet_num='$qt_no'");
...
echo $adv_amnt1=$_POST['adv_amnt1'];
...
if($ad2!=$adv_amnt2 and $adv_amnt2>=1){
	...
	values('$qt_no','$adv_amnt2','$adv_date2','$ses','AP','$ac_det3')");
		 ...
		 ,img1='$iname1',img2='$iname3',img3='$iname5',bal='$bal'
...
`desc1`='".addslashes($pname)."', `hsn`='$hsn', `gst`='$gst', `uom`='$uom', `qty`='$qty', `gst_amnt`='$gst_amnt',
 ...
 serv_code='$serv_code',serv_cap='$serv_codex'

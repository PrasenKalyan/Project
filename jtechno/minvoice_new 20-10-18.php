...
<style type="text/css">
    table { page-break-inside:auto;page-break-inside:auto;border-color:#fff;font-family: "Tahoma", Times, serif;font-size:12px;  }
...
?>
<header>
      <img src="headerlogo.jpg" style="width:100%;height:160px;"/>
    </header>

  <table border='1'  cellpadding="0" cellspacing='0'>
       <thead>
            <tr class="noBorder" ><th   colspan="14"style="padding-top:160px;border-right:none !important;font-size:18px;"></th></tr>
        </thead>
        <tfoot>
...
<table width="500" style="    font-weight: 550;
    font-size: 14px;">
<tr>
...
<div style="border:1px solid #000;">
 ...
 ?>
			<table border="1" cellpadding="0" cellspacing="0" style="    font-weight: 550;
    font-size: 14px;">
			<tr>
...
<div style="border:1px solid #000;margin-top:0px;margin-bottom:38px;margin-top:11px;">
...
<div style="height:0px;margin-top:20px;margin-bottom:0px; margin-top:10px;" ></div>
<div style="border:1px solid #000;font-weight:bold;font-size:14px;" >
<table width="500">
		  <tr>
		  ...
		  <tr>
		  <td >Old Po No &nbsp;&nbsp;&nbsp; <?php echo $opo_no; ?></td>
		  <td>PO DATE&nbsp;&nbsp;&nbsp;<?php if($opo_date1!='0000-00-00'){
			 echo $opo_date; } else {
			echo "";	 
			 }?></td>
		  </tr>
		  <tr>
			...
			Wcc Period  :  <?php if($wcc_pf1!='0000-00-00'){
			 echo $wcc_pf; } else {
			echo "";	 
			 }?><br/>
			Wcc Period&nbsp;:  <?php if($wcc_pt1!='0000-00-00'){
			 echo $wcc_pt; } else {
			echo "";	 
			 }?><br/>
...
<?php
 $y="select distinct(cgst) from add_mbill where service_no='$service_no' ";
...
$cont=mysqli_num_rows($sq);
 ...
 while($r=mysqli_fetch_array($sq)){
	 ...
	 $u="select  sum(tax_amnt) as tax_amnt,sum(gst_amnt) as gst from add_mbill where service_no='$service_no' and cgst='$sggst'";
...
//while($r1=mysqli_fetch_array($t)){
 ...
 $aa="select * from add_mbill where service_no='$service_no' and cgst='$sggst' and id1='$bid' ";
...
while($t1=mysqli_fetch_array($t)){
	...
	<th style="width:120px;"><?php echo $tax=number_format((float)$t1['tax_amnt'],1, '.', ''); ?></th>
...
$i++; }
 ...
 <th style="font-size:16px;"> <?php echo number_format((float)$tax_amnt,2,'.','');?></th>
 </tr>
 ...
 <th style="font-size:16px;"> <?php echo number_format((float)$gst_amnt1/2,1,'.',''); ?></th>
 </tr>
 <tr>
 ...
 <th style="font-size:16px;"> <?php echo number_format((float)$gst_amnt1,1,'.',''); ?></th>
 </tr>
 <?php }else{ ?>
 <tr></tr>
 <?php }?>
 ...
 <th style="font-size:16px;"> <?php echo $tamt=round($tax_amnt+$gst,2); ?></th>
 </tr>
...
//$x++;
 ...
 <td colspan="3" align="right" style="font-size:14px;"><b>Taxable Amount -
...
echo implode('+', $s);
 ...
 <th style="font-size:16px;"> <?php echo number_format((float)$total_cgst,1,'.',''); ?></th>
 </tr>
 <tr>
 <td colspan="3" align="right" style="font-size:14px;"><b>ADD:SGST</b></td>
 <th style="font-size:16px;"> <?php echo number_format((float)$total_sgst,1,'.',''); ?></th>
 </tr>
 <tr>
 <td colspan="3" align="right" style="font-size:14px;"><b>ADD:IGST</b></td>
 <th style="font-size:16px;"> <?php echo '--'; ?></th>
 </tr>
 <tr>
 <td colspan="3" align="right" style="font-size:14px;"><b>TOTAL GST AMOUNT</b></td>
 <th style="font-size:16px;"> <?php echo number_format((float)$total_gst,1,'.',''); ?></th>
 </tr>
 
 <tr>
 <td colspan="3" align="right" style="font-size:14px;"><b>Total Amount After Tax </b></td>
 <th style="font-size:16px;"> <?php echo number_format((float)$tamt1,2,'.',''); ?></th>
 </tr>
 ...
 ?> 
    ...
    <td></td><td align="center"><input type="button" value="Print" id="prt" class="butt" onclick="printt()"/></td><td><input type="button" value="Close" id="cls" class="butt"  onclick="javascript:location.href='mbill_list.php'"/></td>
</tr></table>
...
<div>Branch Office : A3/302,Kohinoor Estate, Mulla Road, Wakedewadi,Pune-411001.</div>	

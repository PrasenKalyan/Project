...
header("Content-disposition: attachment; filename=gthsnreport".date('d-m-Y').".xls");
...
<center><h2><u>Gujarat HSN Code Report Summery</u></h2></center>
<div >
...
$t="select a.service_no,a.item_desc,a.hsnno,a.sacno,a.qty,a.price,a.cgst,a.tax_amnt,a.cgstamount,a.sgst,a.sgstamount,b.date from add_gbill1 b,add_gbill a where a.service_no=b.service_no and b.date between '$from' and '$to'  order by a.hsnno desc,b.date desc  ";

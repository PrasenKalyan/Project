...
include('dbconnection/connection.php');
  ...
  $loc=$_GET['loc'];
   $sno=$_GET['sno'];
 $from=$_GET['email'];
 $p=mysqli_query($link,"select * from add_apbill1 where id=' $id'") or die(mysqli_error($link));
...
$subject = "OSPS Andhra Billing Invoice No".$sno;
...
$success = mail($to,$subject,$message,$headers);
  ...
  echo "Mail to " . $to . " failed .";
         ...
         unlink($doc);
        header('Location:aandhrabill_list.php');

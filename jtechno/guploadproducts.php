                        ...
                        <div class="row">
                            <div class="col-xs-6">
                               <div class="box box-info">
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="guploadproducts_suc.php" enctype="multipart/form-data" autocomplete="off">
...
<div style="height:15px;"></div>
                ...
                <input type="text" class="form-control pull-right" id="search" name="search" placeholder="Search By Item Code or Item Description ">
                  </div>
				   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                        ...
                                        <div>
											...
											if(isset($_POST['bsearch'])){
											 ...
											 $y="select * from gproducts where item_code like  '%$bsearch%' or item_desc like  '%$bsearch%' ";
...
<td class="center">
                                                        ...
                                                        <td class="hidden-480"><?php echo $rs1['item_category']; ?></td>
                                                         ...
                                                         <td>
														 <a href="edit_gprd.php?id=<?php echo $rs1['id'];?>"><img src="images/edit.gif"></a>
														 <a href="delete_gprd.php?id=<?php echo $rs1['id'];?>"><img src="images/Icon_Delete.png"></a>
														 </td>
...
$start_from = ($page-1) * $results_per_page;
                                                    ...
                                                    //$q="select * from gproducts order by id desc limit 1000";
...
echo "<li><a href='guploadproducts.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='guploadproducts.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

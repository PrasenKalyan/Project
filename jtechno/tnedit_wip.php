                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="qot_list.php"> Work in Progress  List</a>
                            </li>
                            <li>
                                <a href="">Edit Work in Progress </a>
                            </li>
 ...
 <input type="hidden" name="ids" value="<?php echo $id?>">
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
			...
			print "</script>";
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="tnwipl_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">

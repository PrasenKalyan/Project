...
<table border='1' style="width:90%" align="center"  cellpadding="0" cellspacing='0'>
        <thead>
            <tr class="noBorder" ><th   colspan="14"style="border-right:none !important;font-size:18px;">
...
<td ><b>State:</b><?php echo $state1;?></tr>


<tr><td ><b>InvoiceDate:</b><?php $d=$r['inv_date']; echo date('d-m-Y', strtotime($d));?></td>
<td ><b>State Code :</b><?php echo $state_code;?></tr>

<tr><td ><b>PO No:</b><?php echo $r['po_no']?></td>
<td ><b>PO Date :</b><?php echo $r['po_date'];?></tr>
...
<table  width="500" ><tr>
<td><b>SERVICE PROVIDER DETAILS</b><hr /></td></tr>
...
<tr>
 ...
 ?> 
	...
	<tr class="noBorder" ><th   colspan="14"style="border-right:none !important;font-size:18px;">
			<img src="footerraisedinvoice.jpeg" height="200"/></th></tr>
      </tbody>
    </table></td></tr></table>

                ...
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-header">
                            <h1 align="center">
                              TG  Mark Not Required File View
                            </h1>
                        </div>
									...
									<input type="hidden" name="id1" 
										...
										if(isset($_POST['update'])){
											...
											$qt_no=$_POST['qt_no'];
												...
												$sq=mysqli_query($link,"update  tgrequest_amnt set docr_status='$status' where id='$id'");
											
											 	$yt="update add_tgqot set status='Not Required'  where quet_num='$qt_no'";
if($status=="approved"){
 $k=mysqli_query($link,$yt) or die(mysqli_error($link));   
			...
			print "self.location='tgwork1.php';";
			print "</script>";
										}
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="tgwork1.php"><button class="btn btn-danger" type="button" name="button" id="Close">

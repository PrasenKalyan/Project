...
$s_code=$_POST['s_code'];	
	...
	$sq=mysqli_query($link,"INSERT INTO `knitems`(`mdescription`, `umo`, `hsncode`, `urate`, `gst`, 
	...
	print "self.location='knuploaditems_list.php';";
	print "</script>";
...
$s_fee=$_POST['s_fee'];
$s_code=$_POST['s_code'];		
	$sq=mysqli_query($link,"update  `kitems` set `mdescription`='$mdesc', `umo`='$umo', `hsncode`='$hsn',

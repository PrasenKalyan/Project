...
$start_from = ($page-1) * $results_per_page;
											...
											(('$status' <> ' ' and locate('$status', a.status) <> 0) or ('$status' = ' '  and 1 = 1) ) and a.store_code=b.store_code";
													 ...
													 if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='tnbilling') or ($tsname=='sumanthpotluri') or ($tsname=='manikandan')or ($tsname=='naiduys')){
											  ...
											  if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='tnbilling') or ($tsname=='sumanthpotluri') or ($tsname=='manikandan')){
													// $y="SELECT * FROM ".$datatable." where status='work to be started'   ORDER BY id desc LIMIT $start_from, ".$results_per_page;   
...
$r1=mysqli_fetch_array($ssq1);
                                            ...
                                            <!--            or ($tsname=='jfmtn22230069')-->
                                                      
                                                    <td class="hidden-480">
                                                        <?php 	if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='sumanthpotluri') or ($tsname=='manikandan')or ($tsname=='vinoth') or ($tsname=='JFMTN22230069') or ($tsname=='tnbilling')){ ?>

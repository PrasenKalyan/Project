...
echo "<li><a href='knsupervisor.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='knsupervisor.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

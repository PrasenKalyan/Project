...
<div class="row">
 ...
 <form name="frm" method="post" action="mbill_status.php">
<input type="hidden" name="id" value="<?php echo $r['id']?>">
 <input type="hidden" name="location" value="<?php echo $r['location'];?>">
  <input type="hidden" name="email" value="<?php echo $email;?>">
                                        ...
                                        <td align="right">PO Date</td><td><input type="date" required name="po_date" id="po_date" value="<?php echo $r['po_date'];?>"  class="form-control"></td>
                                        </tr>
                                        ...
                                        <td align="right">Req.Ref.No</td><td><input type="text" name="req_ref" onChange="showHint22(this.value)"  id="req_ref" value="<?php echo $r['req_ref'];?>" required class="form-control"></td>
                                        </tr>
                                        ...
                                        <td align="right">State</td><td><input type="text" id="state" name="state" required value="<?php echo $r['state'];?>" class="form-control"></td>
                                        </tr>
                                        ...
                                        <td align="right">WCC NO</td><td>
                                            <input type="hidden" name="user" value="<?php echo $name; ?>"/>
                                            
                                            <input type="text" name="wcc_num" value="<?php echo $r['wcc_num'];?>" required class="form-control"></td>
                                        </tr>
						...
						<input type="text" name="cgstamt[]" value="<?php echo $rs1['cgstamount']; ?>" style="width:60px;" readonly class="txt51" id="cgstamt<?php echo $i?>" />   
									...
									?>
                                        ...
                                        <div class="col-md-offset-4 col-md-8">
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="mabill_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">

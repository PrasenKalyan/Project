                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="#">TN Work in Progress List</a>
                            </li>
                            <li>
                                <a href="#">Work in Progress  List</a>
                            </li>
...
<div class="row">
			...
			<!--	   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
										...
										if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='tnbilling') or ($tsname=='sumanthpotluri') or ($tsname=='manikandan')or ($tsname=='naiduys')  ){
...
echo date('d-m-Y', strtotime($d)); }?></td>
                                                        ...
                                                        <td class="hidden-480">
                                                             ...
                                                             <?php if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='tnbilling') or ($tsname=='sumanthpotluri') or ($tsname=='manikandan')){ ?>
                                                            
                                                            <a href="tnedit_wip.php?id=<?php echo $rs1['quet_num']; ?>&id1=<?php echo $r1['id'];?>">
                                                        <img src="images/edit.gif"></a>
                                                        
                                                        <?php }else{?>
                                                        <img src="images/edit.gif">
                                                        <?php }?>
                                                         <?php if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname==$ses) or ($tsname=='sumanthpotluri') or ($tsname=='manikandan') ){ ?>
...
echo "<li><a href='tnwip_list.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='tnwip_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

...
function report()
{
   if (document.form.fromdate.value == "") {
	...
	if (document.form.todate.value == "") {
	  ...
	  window.open('date_wise1.php?s_date='+s_date+'&e_date='+e_date,'mywindow1','width=1020,height=700,toolbar=no,menubar=no,scrollbars=yes')
                            ...
                            <div class="col-xs-6">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title">Date wise invoice list</h3>
								</div>
                               
                                <form class="form-horizontal" name="form" id="validation-form" role="form" method="post"  autocomplete="off">
								   ...
								   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-4 col-md-8">
                                            <button class="btn btn-info" type="submit" name="submit" id="Update" onclick="report();">

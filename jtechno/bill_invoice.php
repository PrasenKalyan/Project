               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                   ...
                                   <div style="overflow-x:auto;">     
											...
											$ssq1="select * from qot_bill where status='RUn Paid' ";
													       ...
													       if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='apbilling')or ($tsname=='sumanthpotluri')){
													           $ssq1="select * from qot_bill where status='RUn Paid' ";
													      }else{
											...
											while($rs1=mysqli_fetch_array($t)){
                                                   ...
                                                   <td>
													...
													<td class="hidden-480"><a href="qotti_pdf.php?id=<?php echo $rs1['quet_num']; ?>">
                                                         <img src="images/pdf_icon.gif" width="30" height="30"></a></td>
													<td class="hidden-480"><a href="qotbrk_excel.php?id=<?php echo $rs1['quet_num']; ?>">
                                                          <img src="images/xl.jpg" width="20" height="20"></a></td>
													   <td class="hidden-480"><a href="qotbrk_pdf.php?id=<?php echo $rs1['quet_num']; ?>">
                                                         <img src="images/pdf_icon.gif" width="30" height="30"></a></td>

...
$sheet->setCellValue('S6', 'Advance Amount');
$sheet->setCellValue('T6', 'Remarks');
$sheet->setCellValue('U6', 'Whom to be Invest Amount');
$sheet->setCellValue('V6', 'Request Amount');
$sheet->setCellValue('W6', 'Rq Amount Date');
...
while ($row = $result->fetch_assoc()) {
    ...
    $ads = $db->query($adamt) or die(mysqli_error($link));
    ...
    $sheet->setCellValue('W' . $rowCount, mb_strtoupper($row['req_date'], 'UTF-8'));
...
$result10 = $db->query($y2) or die(mysqli_error($link));
$cnt2 = 1;
$j = 1;
$rowCount1 = $tc + $cnt2;
...
header('Content-Disposition: attachment;filename="knaprvamountlist.xlsx"');

									...
									<input type="hidden" name="id1" 
										...
										if(isset($_POST['update'])){
                                            ...
                                            $status=$_POST['status'];										
												...
												$sq=mysqli_query($link,"update  odrequest_amnt set gstatus='$status' where id='$id'");
											
										if($sq){
												
			print "<script>";
			print "alert('Bill Sucessfully Updated');";
			print "self.location='odwork2.php';";
			print "</script>";
										}
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="odwork2.php"><button class="btn btn-danger" type="button" name="button" id="Close">

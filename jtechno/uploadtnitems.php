                            ...
                            <div class="col-xs-6">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title">Upload TN Items List</h3>
								</div>
                               
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="upload_tnitems.php" enctype="multipart/form-data" autocomplete="off">

...
<html lang="en">
    ...
    <style>
    /* Define styles for elements with class 'strong' */
    .strong {
        color: red;
    }

    /* Define styles for elements with class 'reload' */
    .reload {
        font-family: 'Lucida Sans Unicode'; /* Add the missing semicolon and enclose the font name in quotes */
        cursor: pointer;
        float: left;
    }
    ...
    /* Define a keyframe animation named 'spin' */
    @keyframes spin {

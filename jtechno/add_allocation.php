...
xmlhttp.send();
                     ...
                     if(isset($_POST['submit'])){
                            ...
                            $pono=$_POST['pono'];
                            $qry=mysqli_query($link,"insert into allocations(indusid,allocationdetails,prno,prvalue,received,pono)values
                            ('$indusid','$allocationdetails','$prno','$prvalue','$received','$pono')");
                            if($qry){
                                print "<script>";
                            	print "alert('Successfully Registred ');";
                            	print "self.location='add_allocation.php';";
                            	print "</script>";
                            }
...
<div class="row">
 ...
 <form name="frm" method="post" id="register-form" action="">
										 ...
										 <input id=\"store_code\" list=\"city1\" required class="form-control" name="indusid" onChange="showHint22(this.value)" >
<datalist id=\"city1\" >
		...
		?>								 
									...
									<input type="text" name="towertype" id="towertype" required class="form-control">
                                      ...
                                      <td align="right">Allocation Details</td><td>
                                        <textarea  name="allocationdetails" id="allocationdetails"  class="form-control"></textarea>
                                     ...
                                     <tr>
                                        ...
                                        <input type="text" name="prno" id="prno"  class="form-control">
                                        
                                       </td>
                                        
                                      <td align="right">PR Value</td><td>
                                        <input type="text"  name="prvalue" id="prvalue"  class="form-control"/>
                                      ...
                                      <td align="right">Po Status Received</td><td>
                                       ...
                                       <td id="preceived1" style="display:none;"><input type="text" name="pono" id="pono"  class="form-control"></td>
                                       </tr>
                                        <tr >

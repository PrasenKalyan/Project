...
$bid=$_GET['id'];
 $name1=$_GET['name1'];
  $name2=$_GET['name2'];
$loc=$_GET['loc'];
$q=mysqli_query($link,"select * from add_knqot where id='$bid'") or die(mysqli_error($link));
...
$mpdf->Output('demo.pdf','F');
		...
		print "<script>";
	print "self.location='knemailqot.php?cord=$cor_email&supr=$sup_email&qot=$qut';";
	print "</script>";

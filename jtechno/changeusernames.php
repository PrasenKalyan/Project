 ...
 <form name="frm" method="post" id="register-form" action="" enctype="multipart/form-data">
                                        ...
                                        if(isset($_POST['submit'])){
                                          ...
                                          if($state=="AP"){
                                             ...
                                             $tt="update request_amnt set user='$luser' where quet_num='$quotation'";
                                          }else if($state=="TS"){
                                                $t="update add_tgqot set ses='$luser' where quet_num='$quotation'";
                                                  $tt="update tgrequest_amnt set user='$luser' where quet_num='$quotation'";
                                          }else if($state=="KL"){
                                                $t="update add_klqot set ses='$luser' where quet_num='$quotation'";
                                                  $tt="update klrequest_amnt set user='$luser' where quet_num='$quotation'";
                                          }else if($state=="TN"){
                                                $t="update add_tnqot set ses='$luser' where quet_num='$quotation'";
                                                  $tt="update tnrequest_amnt set user='$luser' where quet_num='$quotation'";
                                          }else if($state=="KN"){
                                                $t="update add_knqot set ses='$luser' where quet_num='$quotation'";
                                                 $tt="update knrequest_amnt set user='$luser' where quet_num='$quotation'";
                                          }
	
	
	
	                                        $kl=mysqli_query($link,$t) or die(mysqli_error($link));
	                                        $klk=mysqli_query($link,$tt) or die(mysqli_error($link));
	                                        if($kl && $klk){

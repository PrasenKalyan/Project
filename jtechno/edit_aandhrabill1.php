                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="bill_list.php"> Edit Ap Billing</a>
                            </li>
                            <li>
                                <a href="">Edit AP Billing</a>
                            </li>
...
<div class="row">
 ...
 <form name="frm" method="post" action="aapbill_status.php">
 ...
 <input type="hidden" name="location" value="<?php echo $r['location'];?>">
  <input type="hidden" name="email" value="<?php echo $email;?>">
                                        ...
                                        <td align="right">Req.Ref.No</td><td><input type="text" name="req_ref" id="req_ref" onblur="showHint22(this.value)" value="<?php echo $r['req_ref'];?>" required class="form-control"></td>
                                        </tr>
...
<button type="button" class='btn btn-danger delete'>-</button>
											...
											<?php   //$id=count($_POST['id']);
											 $aa="select * from add_apbill where id1='$id'";
						...
						<input type="text" name="cgstamt[]" value="<?php echo $rs1['cgstamount']; ?>" style="width:60px;" readonly class="txt51" id="cgstamt<?php echo $i?>" />   
									...
									?>
                                        ...
                                        <div class="col-md-offset-4 col-md-8">
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="aandhrabill_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">

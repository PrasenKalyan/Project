...
?>
   ...
   <!-- style="width:100%;height:120px;"-->
    ...
    <table border='1'  cellpadding="0" cellspacing='0'>
        <thead>
            <tr class="noBorder" ><th   colspan="9" style="padding-top:20px;border-right:none !important;font-size:18px;">JTECHNO</th></tr>
 <tr><td colspan="9">      
<hr></td></tr>
	   </thead>
       
      
        <tr><td colspan="8" style="text-align:center;font-size:18px;border:0px;"><b><?php echo $state; ?> QUOTATIONS LIST</b></td></tr>
...
$bid=$r['id'];
	 ...
	 $aa="select * from ".$qottable." where status='work to be started' order by id desc";

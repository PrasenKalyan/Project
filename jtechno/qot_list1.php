                                            ...
                                            <table id="sample-table1" class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
													 ...
													 <th>Edit</th>
													 <th>Email</th>
														     <th>Print</th> <th>Quotation</th><th>Bill of Supply</th>
															 <th>Miscllenious</th>
														 <th>Pdf Download</th>
...
echo "</datalist>";?></datalist></th>
													 ...
													 <th><input type="submit" value="Submit" name="submitkk" class="btn btn-primary" ></th>
														 <th>   <input type="reset" value="Reset" name="submit1" class="btn btn-danger"  onclick="javascript:location.href='qot_list1.php'"> </th>
			<!--
...
$start_from = ($page-1) * $results_per_page;
											...
											(('$status' <> ' ' and locate('$status', a.status) <> 0) or ('$status' = ' '  and 1 = 1) ) and a.store_code=b.store_code";
													...
													//$y="select * from add_qot2 order by id desc";
...
$r1=mysqli_fetch_array($ssq1);
                                                    ...
                                                    <td class="hidden-480"><a href="edit_qot1.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/edit.gif"></a></td>
														
														 <td class="hidden-480"><a onclick="return confirm('Are you sure you want to send the Email?');"  href="qotpdfcheck1.php?id=<?php echo $rs1['id'];?>&name1=<?php echo $r1['coordinator'];?>&name2=<?php echo $r1['superwisor'];?>"
												   class="">
                                                        <img src="images/email.png" width="20" height="20"></a></td>
														
														 <td class="hidden-480">
														 
                                                   <a onclick="window.open('qut_print1.php?id=<?php echo $rs1['id'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')"
												   class="btn btn-primary btn-xs"><img src="images/printer.png"></a>
                                                        </td> 
                                                        
                                                         <td class="hidden-480"><a href="qut_excel1.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                       
                                                     <td class="hidden-480"><a href="qut_excel_bill1.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                       </td>
  <td class="hidden-480"><a href="qut_excel_mis1.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>

													   <td class="hidden-480">
                                                       <a href="qot_pdf1.php?id=<?php echo $rs1['id'];?>"
...
echo "<li><a href='qot_list1.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='qot_list1.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

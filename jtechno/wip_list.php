			...
			<!--	   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                  ...
                                  <div style="overflow-x:auto;">
										...
										if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='apbilling') or ($tsname=='8919765662') or ($tsname=='sumanthpotluri') or ($tsname=='naiduys')){
						...
						$k12="select * from dpr where store_code='$str_code' and superwisor='$supervisor'";
                            ...
                            ?>
                            <?php if(($supervisor==$ename) or($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='apbilling') or ($tsname==$ses) or ($tsname=='sumanthpotluri') or ($tsname=='naiduys') ){?>
...
echo date('d-m-Y', strtotime($d)); }?></td>
                                                        ...
                                                        <td class="hidden-480">
                                                            ...
                                                            <a href="edit_wip.php?id=<?php echo $rs1['quet_num']; ?>&id1=<?php echo $r1['id'];?>">
...
echo "<li><a href='wip_list.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='wip_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

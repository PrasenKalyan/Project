...
?>
   ...
   <!-- style="width:100%;height:120px;"-->
    ...
    <table border='1'  cellpadding="0" cellspacing='0'>
        ...
        <tr style="background-color:#eeece1; "><td colspan="12" style="text-align:center;font-size:18px;border:0px; background-color:#eeece1; "><b>QUOTATION</b></td></tr>
...
<table  width="100%" style="border:1px solid !important; border-right:1px solid !important;  ">
		  ...
		  <tr><td colspan="7"><b>Vendor GSTIN :	36APSPS9687Q1Z5</b></td>
		  <td colspan="7">Vendor State Code : <?php  echo $state_code; ?></td>
		  </tr></table>
	<table width="100%" style="border:1px solid !important; border-top:0px !important;" >
<tr><td  colspan="7"><b>Quotation Date:</b><?php $d=$r['inv_date']; echo date('d-m-Y', strtotime($d));?></td>
<td colspan="7"><b>Quotation Number:</b><?php echo $r['quet_num'];?></tr>

<tr><td colspan="7"><b>FM Fault No:</b><?php echo $r['falt_no'];?></td>
<td colspan="7"><b>FM Fault date :</b><?php $d1=$r['falt_date']; echo date('d-m-Y', strtotime($d1));?></tr>
</table>

   <table width="100%" style="border-bottom:1px solid !important;" >

<tr><td colspan="14"><b>Fault Description:</b>
<?php echo $r['falt_desc'];?>
<!--Door closer & Cylindrical locks required for the Mens & Womens wash rooms--></td></tr>
</table> 

<table  width="100%" ><tr>
<td colspan="14" style="background-color:#b8cce4; " align="center"><b>Bill to Party</b></td>
...
<table  width="100%" ><tr>
<td colspan="14" style="background-color:#b8cce4; " align="center"><b>Ship to Party</b></td>
...
<th style="width:122px;">HSN/ SAC Codes</th>
...
while($t1=mysqli_fetch_array($t)){
	...
	?>
	<tr>
	<th style="width:3px;"><?php echo $i; ?></th>

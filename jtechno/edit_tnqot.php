...
$sql="select distinct store_code from dpr where state='Tamilnadu' or state='Tamilnadu' ";  // Query to collect records
...
?>
										...
										<img src="upload/<?php echo $r['img1'] ?>" width="100"/>
									...
									<img src="upload/<?php echo $r['img4'] ?>" width="100"/>
										...
										<input type="file" name="image5">
										 <img src="upload/<?php echo $r['img5'] ?>" width="100"/>
										...
										<input type="file" name="image6">
										 <img src="upload/<?php echo $r['img6'] ?>" width="100"/>
						...
						<input type="hidden" name="serv_code[]" value="<?php echo $rs1['serv_cap']; ?>" style="width:50px;" class="" id="serv_code<?php echo $i?>" />	   
									...
									<td><input style="width:60px;" type="text" readonly placeholder="Total Serv" name="tot_serv" class="txt5" value="<?php echo $r['tot_ser'];?>" id="tot_serv" />+
										...
										<?php }?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="tnqot_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">

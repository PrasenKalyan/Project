...
<div class="row">
 ...
 <form name="frm" method="post" action="apqot_suc.php" enctype="multipart/form-data">
...
?>
                                        ...
                                        <tr><td align="right">State</td><td align="left"><input <?php if($rono!=''){ echo 'readonly'; }else { echo '';} ?>  readonly type="text" value="<?php echo $r2['state'];?>"  class="form-control" name="state" id="state"></td>
										...
										<input type="text" required name="company" id="company" readonly value="<?php echo $r2['company_name'];?>" <?php if($rono!=''){ echo 'readonly'; }else { echo '';} ?> class="form-control"></td>
                                        </tr>
										...
										<input type="text" required name="afm" id="afm" readonly value="<?php echo $r2['afm'];?>" class="form-control" <?php if($rono!=''){ echo 'readonly'; }else { echo '';} ?>></td>
                                        <td align="right">GSTIN/UIN</td><td><input readonly type="text" name="gst_in" id="gst_in" value="<?php echo $r2['gst_in'];?>" <?php if($rono!=''){ echo 'readonly'; }else { echo '';} ?>  class="form-control"></td>
                                        </tr>
										
										   <tr><td align="right">FM Fault No</td><td align="left">
										<input type="text" required name="falt_no" readonly id="falt_no" value="<?php echo $r['falt_no'];?>" class="form-control"></td>
                                        ...
                                        <td align="right">Sub Type</td><td><input type="text" readonly name="sub_type" 

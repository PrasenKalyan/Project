...
<style>
	...
	$.ajax({          
        	type: "GET",
        	url: "gettnftypedescriptionauto.php",
...
<div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <?php $ssq=mysqli_query($link,"select * from tnqot_bill where id='$id'");
													   $r1=mysqli_fetch_array($ssq);
													   $gst28p=($r1['gst28']*28)/100;
													   $gst18p=($r1['gst18']*18)/100;
													   $gst5p=($r1['gst5']*5)/100;
													    $gst12p=($r1['gst12']*12)/100;
													     $gst0p=($r1['gst0']*0)/100;
													   $tgst=$gst28p+$gst18p+$gst5p+$gst12p+$gst0p;
													   $tbase1=$r1['tbase']+$tgst;
													   ?>
 ...
 <input type="hidden" name="ids" value="<?php echo $id?>">
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
                                            <table class="table table-striped table-bordered table-hover">
											  ...
											  <input  type="text" readonly  class="form-control" value="<?php echo $r1['quet_num']?>" required  name="qt_no" id="qt_no"></td>
										...
										id="adv_amnt"  class="form-control" value="<?php echo $r1['inv_num'];?>" required></td>	
                                        <td align="right">Invoice Date</td><td><input type="date" name="inv_date" 
										id="sub_type"  class="form-control" value="<?php echo $r1['inv_date'];?>"></td>
                                        </tr>
										...
										id="sub_type"  class="form-control" required value="<?php echo $r1['inv_sub_date'];?>">
										</td>
                                        </tr>
											<tr><td align="right">Service Period</td><td align="left">
										<input type="text" name="speriod" id="speriod" required class="form-control" value="<?php echo $r1['speriod'];?>" /></td>	
                                        <td align="right">Format Type</td><td>
										<input id="ftype1" type="text" class="form-control" required name="ftype" onkeyup='s3(1)'  value="<?php echo $r1['ftype'];?>" >
										<div id='suggesstion-box1'>

										</td>
                                        </tr>
										<tr><td align="right">Total Base Amount</td><td align="left">
										<input type="text" name="tbase" id="tbase" class="form-control" required readonly  value="<?php echo $r1['tbase'];?>" /></td>
										...
										<input type="text" name="gst28" id="gst28" class="form-control tet2" onchange="test()"  value="<?php echo $r1['gst28'];?>"/></td>
										<td align="left">
										<input type="text" name="gst280" id="gst280" class="form-control tet3" value="<?php echo $gst28p; ?>" readonly/></td>
										<td align="left">View File
										<input type="hidden" name="img" id="img" class="form-control tet2"  value="<?php echo $r1['file'];?>"/><a href="iupload/<?php echo $r1['file'] ?>">Check View</a></td>
										
										
                                        </tr>
										<tr><td align="right">18 % Gst</td><td align="left">
										<input type="text" name="gst18" id="gst18" class="form-control tet2" onchange="test1()"  value="<?php echo $r1['gst18'];?>"/></td>
										<td align="left">
										<input type="text" name="gst180" id="gst180" class="form-control tet3" readonly value="<?php echo $gst18p; ?>"/> </td>
										
                                        </tr>
										<tr><td align="right">12 % Gst</td><td align="left">
										<input type="text" name="gst12" id="gst12" class="form-control tet2" onchange="test2()"  value="<?php echo $r1['gst12'];?>"/></td>
										<td align="left">
										<input type="text" name="gst120" id="gst120" class="form-control tet3" readonly value="<?php echo $gst12p; ?>"/></td>	
                                        </tr>
										<tr><td align="right">5 % Gst</td><td align="left">
										<input type="text" name="gst5" id="gst5" class="form-control tet2" onchange="test3()"  value="<?php echo $r1['gst5'];?>"/></td>
										<td align="left">
										<input type="text" name="gst50" id="gst50" class="form-control tet3" readonly value="<?php echo $gst5p; ?>"/></td>	
                                        </tr>
										<tr><td align="right">0 % Gst</td><td align="left">
										<input type="text" name="gst0" id="gst0" class="form-control tet2" onchange="test4()"  value="<?php echo $r1['gst0'];?>"/></td>
										<td align="left">
										<input type="text" name="gst00" id="gst00" class="form-control tet3" readonly value="<?php echo $gst0p; ?>"/></td>	
                                        </tr>
									
									
									<tr><td></td>
									    <td align="right">Total Gst</td><td align="left">
									<input type="text"  id="totamount" class="form-control" value="<?php echo $tgst ?>" readonly/></td>
									</tr>
									
									<tr><td></td>
									    <td align="right">Final Amount</td>
									<td>	<input type="text"  id="totamount1" value="<?php echo $tbase1 ?>" class="form-control" readonly/></td>
									</tr>
									
									
									<input type="hidden" name="id1" 
										id="id"  class="form-control" value="<?php echo $r1['id'];?>">
                                        </table>
	...
	$iname5 = ($iname5);
	 ...
	 $iname5 = ($img3);
												...
												$sq=mysqli_query($link,"update  tnqot_bill set quet_num='$qt_no',bill_date='$bill_date',
												inv_num='$inv_no',inv_date='$inv_date',note1='$note',inv_sub_date='$inv_sub_date',status='Un Paid',
												speriod='$speriod',ftype='$ftype',tbase='$tbase',gst28='$gst28',gst18='$gst18',gst12='$gst12',gst5='$gst5',
												gst0='$gst0',total='$total',file='$iname5'    where id='$id' ");
												
											
											if($state=='TN'){
												$s=mysqli_query($link,"update add_tnqot set
												bill_rec_date='$bill_date',invoice_no='$inv_no',invoice_date='$inv_date',inv_sub_date='$inv_sub_date',invoice_status='$st',status='Payment Pending' where quet_num='$qt_no'");
											} 
											
											print "<script>";
			print "alert('Invoice Sucessfully Updated');";
			print "self.location='tnbill_list2.php';";
			print "</script>";
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="tnbill_list3.php"><button class="btn btn-danger" type="button" name="button" id="Close">

...
?>
   ...
   <tr><td><br></td></tr><tr><td><br></td></tr><tr><td><br></td></tr><tr><td><br><br></td></tr>
    ...
    <table border='1'  cellpadding="0" cellspacing='0'>
        ...
        <tr style="background-color:#eeece1; "><td colspan="10" style="text-align:center;font-size:18px;border:0px; background-color:#eeece1; "><b>BILL OF SUPPLY</b></td></tr>
 ...
 <table >
		...
		<b>	Name of Vendor :<br/>
			...
			<b> JYOTHI INFRA SERVICE<br/>
			 D.No.54-20/2-7A, 8th Line, Bharathi Nagar, Vijayawada, Krishna District-520008.
...
<table  width="100%" style="border:1px solid !important; border-right:1px solid !important;  ">
		  ...
		  <tr><td colspan="5"><b>Vendor GSTIN :	37APSPS9687Q1Z3</b></td>
		  <td colspan="5">Vendor State Code : <?php echo  $state_code ?></td>
		  </tr></table>
	<table width="100%" style="border:1px solid !important; border-top:0px !important;" >
<tr><td  colspan="5"><b>Bill No:</b><?php echo $r['quet_num'];?></td>
<td colspan="5"><b>Bill Date:</b><?php $d=$r['inv_date']; echo date('d-m-Y', strtotime($d));?></tr>
<!--

...
<div class="row">
 ...
 <input type="hidden" name="ids<?php echo $i; ?>" value="<?php echo $id1?>">
  <input type="hidden" name="ses" value="<?php echo $name;?>">
                                       ...
                                       <td align="right"><a href="upload/<?php echo $r1['img1'];?>" target="_blank" >Image 1</a></td>
                                        </tr>
										
										
										<tr><td align="right"><a href="upload/<?php echo $r1['img2'];?>" target="_blank" >Image 2</a></td>
                                        <td align="right"><a href="upload/<?php echo $r1['img3'];?>" target="_blank" >Image 3</a></td>
                                     
                                        </tr>
										 <tr><td colspan="2"><b>After Images</b></td></tr>
                                    	<tr>
                                        <td align="right"><a href="upload/<?php echo $r1['img4'];?>" target="_blank" >Image4</a> </td>
										<td align="right"><a href="upload/<?php echo $r1['img5'];?>" target="_blank" >Image5</a></td>
                                        </tr>
										<tr>	
                                        <td align="right"><a href="upload/<?php echo $r1['img6'];?>" target="_blank" >Image6</a> </td>
                                        </tr>
                                        </table>
							...
							echo $dd="update klrequest_amnt set confirm='$confirm',approve_amnt='$approve_amnt1',remarks='$remarks' where id='$id'";
	...
	if(isset($_POST['update2'])){
							...
							echo $dd="update klrequest_amnt set confirm='$confirm',approve_amnt='$approve_amnt2',remarks='$remarks' where id='$id2'";
							$ssq=mysqli_query($link,$dd);
			...
			print "</script>";
							...
							echo $dd="update klrequest_amnt set confirm='$confirm',approve_amnt='$approve_amnt3',remarks='$remarks' where id='$id3'";
							$ssq=mysqli_query($link,$dd);

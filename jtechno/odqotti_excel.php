...
$objPHPExcel->getActiveSheet()->setCellValue('I12',21);	
$objPHPExcel->getActiveSheet()->setCellValue('D13', $r['po_no']);
$objPHPExcel->getActiveSheet()->setCellValue('I11', OD);
...
$objPHPExcel->getActiveSheet()->setCellValue('C21', OD);
$objPHPExcel->getActiveSheet()->setCellValue('E21', 21);

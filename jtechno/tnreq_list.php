...
<!--<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_qot.php'" id="bsearch">
		...
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                  ...
                  <div class="col-sm-2"><b><a href="qut_tnrreqamt_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b>
...
<!--<td class="center">
										...
										?>
										<?php $qotnum=$rs1['quet_num'];
												            $tyy="select sum(req_amnt+gstamt) as samt from tnrequest_amnt where quet_num='$qotnum' and confirm='Pending'";
										...
										<?php } ?>
											...
											if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='sumanthpotluri') or ($tsname=='manikandan')or ($tsname=='vinoth')){
...
<!--<td class="center">
                                        ...
                                        echo $uy1['ac_det']."-".$at."(".$uy1['req_date'].")<br/>";
                                                       ...
                                                       <td class="hidden-480">
                                                         <?php if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='sumanthpotluri') or ($tsname=='manikandan') or ($tsname=='vinoth')){ ?>

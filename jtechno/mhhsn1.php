...
header("Content-disposition: attachment; filename=mhhsnreport".date('d-m-Y').".xls");
...
<center><h2><u>MH HSN CODE REPORT SUMMERY</u></h2></center>
<div >
...
$t="select a.service_no,a.item_desc,a.hsnno,a.sacno,a.qty,a.price,a.cgst,a.tax_amnt,a.cgstamount,a.sgst,a.sgstamount,b.date from add_mbill1 b,add_mbill a where a.service_no=b.service_no and b.date between '$from' and '$to'  order by a.hsnno desc,b.date desc  ";

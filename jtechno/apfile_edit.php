                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="qot_list.php?state=<?php echo $state; ?>"> Document Required List</a>
                            </li>
                            <li>
                                <a href=""><?php echo $state; ?> Edit Document Required </a>
                            </li>
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-header">
                            <h1 align="center">
                           <?php echo $state; ?> Gst File Upload
                            </h1>
                        </div>
  ...
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
	...
	$iname1 = ($iname1);
	 ...
	 $iname1 = ($img1);
			...
			print "self.location='work2.php?state=$state';";
			print "</script>";
										}
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="work2.php?state=<?php echo $state; ?>"><button class="btn btn-danger" type="button" name="button" id="Close">

...
$k=mysqli_query($link,"select * from odrequest_amnt where quet_num='$id'") or die(mysqli_error($link));
while($k1=mysqli_fetch_array($k)){
	...
	mysqli_query($link,"update add_odqot set status='Approved Amount' where quet_num='$id'") or die(mysqli_error($link));
											print "<script>";

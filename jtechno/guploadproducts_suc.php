	...
	if(in_array($_FILES["file"]["type"],$mimes)){
	 ...
	 //$res=mysql_query($ten_ins) or die(mysql_error());
				$link->query($query);
					...
					$m="update gproducts set  item_desc ='".addslashes($item_desc)."' ,primary_uom='$primary_uom', qty='$qty',price_unit='$price_unit', hsn='$hsn',sac='$sac',item_category='$item_category', cgst='$cgst',sgst='$sgst', igst='$igst'    where category='$category1' and item_code='$item_code1' and location='$location1' ";

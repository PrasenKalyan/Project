...
include'dbfiles/uqry_super.php';
?>
<!DOCTYPE html>
<html lang="en">
                               ...
                               <div class="box box-info">
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action=""  autocomplete="off">
								   ...
								   <div class="form-group">
									 ...
									 <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Supervisor Email </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-4 col-md-8">
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="superwiser.php"><button class="btn btn-danger" type="button" name="button" id="Close">

                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                               ...
                               $mm=mysqli_query($link,"select * from add_klqot where id='$id'") or die(mysqli_error($link));
                               ...
                               $qtpdf=$qtno.".pdf";
                               ?>
                                <form class="form-horizontal" enctype="multipart/form-data" method="post" action="klsendmail.php">
              <div class="box-body">
			  	 <!-- /Employee Photo-->

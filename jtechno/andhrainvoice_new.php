...
$bid=$_GET['id'];
$loc=$_GET['loc'];
$q=mysqli_query($link,"select * from add_apbill1 where id='$bid'") or die(mysqli_error($link));
...
<td><b><?php echo $service_no; ?><br/><?php echo $invdate; ?></b></td>
...
<table  width="500" >
<tr>
<td><b>PAN No:-AAACO8174A<br/>GST NO:-36AAACO8174AIZM</b></td>
...
<?php
  $y="select distinct(cgst) from add_apbill where service_no='$service_no' and id1='$bid' ";
...
$cont=mysqli_num_rows($sq);
 ...
 while($r=mysqli_fetch_array($sq)){
	 ...
	 $u="select  sum(tax_amnt) as tax_amnt,sum(gst_amnt) as gst from add_apbill where service_no='$service_no' and cgst='$sggst'";
...
//while($r1=mysqli_fetch_array($t)){
 ...
 $aa="select * from add_apbill where service_no='$service_no' and cgst='$sggst' and id1='$bid' ";
...
$i++; }
 ...
 <th style="font-size:16px;border-right-color: #000 !important;"> <?php echo number_format((float)$total_amnt,2,'.','');?></th>
 </tr>
...
echo implode('+', $s);
 ...
 <th style="font-size:14px; border-right-color: #000 !important;"> <?php echo number_format((float)$tx1,2,'.','');?></th>
 </tr>

...
?>
   ...
   <!-- style="width:100%;height:120px;"-->
    ...
    border-bottom: 0px;">
  <?php $id=$_GET['id'];
$sq=mysqli_query($link,"select * from old_qot where id='$id'");
...
<td style="width:50%"><b>Quotation Number:</b><?php echo $qt=$r['quet_num'];?></tr>
</table>
<table width="100%" >
...
$bid=$r['id'];
	  ...
	  $aa="select * from old_qot1 where  qot_no='$qt' ";

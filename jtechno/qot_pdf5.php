...
<table border='1' style="width:90%" align="center"  cellpadding="0" cellspacing='0'>
      <tr><td colspan="8">
        ...
        <tr><td colspan="8" style="text-align:center;font-size:18px;border:0px;"><b>BILL OF SUPPLY</b><br /></td></td></tr>
...
<tr><td ><b>Bill Date:</b><?php $d=$r['inv_date']; echo date('d-m-Y', strtotime($d));?></td>

<td ><b>Bill Number:</b><?php echo $qut=$r['quet_num'];?></tr>

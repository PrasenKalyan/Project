...
$product_code=$_POST['product_code'][$i];
 ...
 $query = "INSERT INTO add_knqot1 ( `desc1`, `hsn`, `gst`, `uom`, `qty`, `gst_amnt`, `rate`, `base_amt`,`date`,`id1`,item_id,serv_fee,cap,serv_amt,serv_code,serv_cap,brand,model,remarks,productcode,productype) 
	VALUES 
 ('".addslashes($pname)."','$hsn','$gst','$uom','$qty','$gst_amnt','$price','$amnt','$date','$sno','$id','$serv_amt','$cap','$serv_amnt','$serv_code','$serv_codex','$brand','$model','$remarks','$product_code','$productype')";
...
`desc1`='".addslashes($pname)."', `hsn`='$hsn', `gst`='$gst', `uom`='$uom', `qty`='$qty',`productcode`='$product_code',`productype`='$productype', `gst_amnt`='$gst_amnt',`remarks`='$remarks',

                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="tgbill_list.php"> Document List</a>
                            </li>
                            <li>
                  ...
                  <?php  $qtno=$_GET['id'];
                  $k=mysqli_query($link,"select id from tgrequest_amnt where quet_num='$qtno'") or die(mysqli_error($link));
...
$reason=$_POST['reason'];
		    ...
		    $v="update add_tgqot set status='work to be started',
...
gst_amount2='0.00',gst_amount3='0.00',gst_amount4='0.00',reason='$reason',doctoworkrevertfile='$iname1'		
	...
	$sq=mysqli_query($link,$v) or die(mysqli_error($link));
											 ...
											 echo	$dd="delete from tgrequest_amnt where quet_num='$qt_no'";

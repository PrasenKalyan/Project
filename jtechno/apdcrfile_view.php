                ...
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-header">
                            <h1 align="center">
                            <?php echo $state; ?> Mark Not Required File View
                            </h1>
                        </div>
									...
									<input type="hidden" name="id1" 
										...
										if(isset($_POST['update'])){
											...
											$qt_no=$_POST['qt_no'];
												...
												$yt="update ".$qottable." set status='Not Required'  where quet_num='$qt_no'";
if($status=="approved"){
 $k=mysqli_query($link,$yt) or die(mysqli_error($link));   
			...
			print "self.location='work1.php?state=$state';";
			print "</script>";
										}
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="work1.php?state=<?php echo $state; ?>"><button class="btn btn-danger" type="button" name="button" id="Close">

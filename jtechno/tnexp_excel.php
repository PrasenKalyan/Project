...
//	if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='vishnu')){
     $y="SELECT * FROM expenses where state='TN' ORDER BY id desc";    
    //}else{
...
$sqy=mysqli_query($link,"SELECT * FROM expenses where state='TN' ORDER BY id desc");  
...
header('Content-Disposition: attachment;filename="tnexpenses.xlsx"'); //tell browser what's the file name

			...
			<!--	   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                        ...
                                        $start_from = ($page-1) * $results_per_page;
											...
											$y="SELECT * FROM odqot_bill where   quet_num like  '%$bsearch%'  ";
											} else {
											    
											      if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='odbilling')){
											    
													 $y="SELECT * FROM odqot_bill where     inv_num!=''  order by id asc  LIMIT $start_from,$results_per_page  ";
											      }else{
											         $y="SELECT * FROM odqot_bill where status='payment pending' and inv_num!='' and user='$tsadmin'  order by id asc  LIMIT $start_from,$results_per_page ";
											    }
...
echo date('d-m-Y', strtotime($d)); }?></td>
											...
											<td class="hidden-480"><?php 
                                                        ...
                                                        <td class="hidden-480">
                                                             ...
                                                             <?php  if(($tsname=='admin') or ($tsname=='durgarao')  or ($tsname=='odbilling')){ ?>
                                                             <a href="odinvoicedownload.php?id=<?php echo $q; ?>&id1=<?php echo $rs1['id'];?>">
...
echo "<li><a href='odinvoice_list2.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='odinvoice_list2.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

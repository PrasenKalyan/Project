...
{
 $.ajax({
     url: 'get_items.php', //This is the current doc
     type: "POST",
                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="#">TS Quotations</a>
                            </li>
                            <li>
                                <a href="qot_list.php"> TS Quotations List</a>
                            </li>
                            <li>
                                <a href="">Edit TS Quotations</a>
                            </li>
...
?>
										...
										<img src="<?php echo $r['img1'];?>" onclick="window.open('qut_image.php?id=<?php echo $r['img1'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;">
										</td>
										<td align="right">Image2</td><td align="left">
										<input type="file" name="imagea">
										<img src="<?php echo $r['img2'];?>" onclick="window.open('qut_image.php?id=<?php echo $r['img2'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;"></td>
                                        </tr>
										<tr>	
                                        <td align="right">Image3 </td><td>
										<input type="file" name="imageb">
										<img src="<?php echo $r['img3'];?>" onclick="window.open('qut_image.php?id=<?php echo $r['img3'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;">
										</td>
                                        </tr>
                                    <tr><td colspan="2"><b>After Images</b></td></tr>
										...
										<img src="<?php echo $r['img4'];?>" onclick="window.open('qut_image.php?id=<?php echo $r['img4'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;">
										</td>
										<td align="right">Image5</td><td align="left">
										<input type="file" name="image5">
										<img src="<?php echo $r['img5'];?>" onclick="window.open('qut_image.php?id=<?php echo $r['img5'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;"></td>
                                        </tr>
										<tr>	
                                        <td align="right">Image6 </td><td>
										<input type="file" name="image6">
										<img src="<?php echo $r['img6'];?>" onclick="window.open('qut_image.php?id=<?php echo $r['img6'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;">
										</td>
                                        </tr>
...
<button type="button" class='btn btn-danger delete'>-</button>
  ...
  <tr><td colspan="3"><a onclick="window.open('adduitems.php','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" > Add Items </a></td>
											...
											<?php  
											// updated line issue resolved 
											include('dbconnection/connection.php');
											$id = is_array($_POST['id']) ? count($_POST['id']) : 0;
											 $id1=$_GET['id'];
											 $aa="select * from add_tgqot1 where id1='$id1'";
												...
												<?php if($rono!=' '){ ?>
													<a onclick="return confirm('Are you sure you want to delete this item?');" href='delete_tgline.php?id=<?php echo $rs1['id']; ?>&id1=<?php echo $rs1['id1'];?>'><input type="button" class="btn btn-danger" value="Delete"></button></a>
						...
						<input type="text" name="serv_amt[]" value="<?php echo $rs1['serv_fee']; ?>" style="width:60px;" class="txt21" data-row="<?php echo $i?>"    id="serv_amt<?php echo $i?>" />
                                                		...
                                                		<td class="hidden-480">
														<input type="text" name="remarks[]" <?php if($rono!=''){  ''; }else { echo '';} ?> style="width:100px;" value="<?php echo $rs1['remarks']; ?>"></td>
                                                       <td>
						...
						<input type="hidden" name="product_code[]" value="<?php echo $rs1['product_code']; ?>" style="width:50px;" class="" id="product_code<?php echo $i?>" />	   
									...
									<td><input style="width:60px;" type="text" readonly placeholder="Total Serv" name="tot_serv" class="txt5" value="<?php echo $r['tot_ser'];?>" id="tot_serv" />+
										...
										<?php }?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="qot_tglist.php"><button class="btn btn-danger" type="button" name="button" id="Close">

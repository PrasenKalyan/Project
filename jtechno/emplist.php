                            ...
                            <div class="col-xs-6">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title">JIO Upload Employees</h3>
								</div>
                               
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="jiouploademp_suc.php" enctype="multipart/form-data" autocomplete="off">
...
<div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS -->
                                <div class="row">
                                   <a href="addjiostores.php"><button type="button" class="btn btn-success">Add Jio Stores</button></a>
                ...
                <input type="text" class="form-control pull-right" id="search" name="search" placeholder="Search By Store Name ">
                  </div>
				   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                        ...
                                        <div>
											...
											if(isset($_POST['bsearch'])){
											 ...
											 $y="select * from dpr where store_name like  '%$bsearch%' ";
...
<td class="center">
                                                        ...
                                                        <td class="hidden-480"><?php echo $rs1['city']; ?></td>
                                                        ...
                                                        <td class="hidden-480"><?php echo $rs1['store_name']; ?></td>
                                                         ...
                                                         <td>
														 <a href="edit_jiodpr.php?id=<?php echo $rs1['id'];?>"><img src="images/edit.gif"></a>
														  <a href="delete_jiodpr.php?id=<?php echo $rs1['id'];?>"><img src="images/Icon_Delete.png"></a>
														 </td>
...
echo "<li><a href='jiouploaddpr.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='jiouploaddpr.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

...
echo "</datalist>";?></datalist></th>
													 ...
													 <th><input type="submit" value="Submit" name="submitkk" class="btn btn-primary" ></th>
														 <th>   <input type="reset" value="Reset" name="submit1" class="btn btn-danger"  onclick="javascript:location.href='qot_list3.php'"> </th>	 <th></th>
			<!--
...
$r1=mysqli_fetch_array($ssq1);
                                                        ...
                                                        <td ><?php  $d= $rs1['inv_date']; echo date('d-m-Y', strtotime($d)); ?></td>
                                                         ...
                                                         <td><a href="qot_pdf5.php?id=<?php echo $rs1['id'];?>"
												   class=""><img src="images/pdf_icon.gif" width="30" height="30"></a>
														</td>
                                                      
  <td ><a href="qut_excel_misk1.php?id=<?php echo $rs1['id']; ?>">
...
echo "<li><a href='qot_list3.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='qot_list3.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

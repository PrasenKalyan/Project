                        ...
                        <!-- PAGE CONTENT BEGINS -->
                                ...
                                <div class="row">
									...
									<!--<a href="addbill.php"><button type="button" class="btn-success btn-sm ">Add New</button></a>-->
                                        ...
                                        <center><b>Purchase Order List</b></center>
                                        </div>
...
<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_po.php'" id="bsearch">   Add New  </button>
		<?php }?>
</div>
...
echo "<li><a href='odpo_list.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='odpo_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

...
$bid=$_GET['id'];
 $name1=$_GET['name1'];
  $name2=$_GET['name2'];
$loc=$_GET['loc'];
$q=mysqli_query($link,"select * from add_qot2 where id='$bid'") or die(mysqli_error($link));
...
$i++; }
 ...
 <tr>
	<th  colspan="12"> SGST/UGST Amt (In Rs)</th>
...
<tr>
	<th  colspan="12"> CGST Amt (In Rs)</th>
 ...
 <tr>
	<th  colspan="12"> IGST Amt (In Rs)</th>
	...
	<tr>
	<th  colspan="12"> Total GST  (In Rs)</th>
	...
	<th style="width:120px;"><?php echo $tx1;?></th>
		...
		<tr>
	<th  colspan="12"> Total Amount (In Rs)</th>
 ...
 <tr>
	<th  colspan="12"> Total Invoice Amount in Words
...
$mpdf->Output('demo.pdf','F');
		...
		print "<script>";
	print "self.location='emailqot1.php?cord=$cor_email&supr=$sup_email&qot=$qut';";
	print "</script>";

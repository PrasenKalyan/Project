...
include'dbfiles/uqry_caste.php';
?>
<!DOCTYPE html>
<html lang="en">
                               ...
                               <div class="box box-info">
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action=""  autocomplete="off">
								   ...
								   <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="acyear" name="acyear" required placeholder="Enter Caste Name" value="<?php echo $acyear;?>" /> 
...
<td class="center">
                                                        ...
                                                        <td class="hidden-480"><?php echo $rs1['caste_name']; ?></td>
                                                        ...
                                                        <td>
                                                            <div class="hidden-sm hidden-xs action-buttons">
                                                                ...
                                                                <a href="editcaste.php?id=<?php echo $rs1['id']; ?>"  class="data green"  > <i class="ace-icon fa fa-pencil bigger-130"></i></a>
                                                                <a class="red" href="dbfiles/deletecaste.php?id=<?php echo $rs1['id'];  ?>" onclick="return ConfirmDialog();">

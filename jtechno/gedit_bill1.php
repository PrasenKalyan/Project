...
<div class="row">
 ...
 <input type="hidden" name="id" value="<?php echo $id?>">
                                        ...
                                        <tr><td align="right">PO No</td><td align="left"><input  type="text" value="<?php echo $r['po_no'];?>"  class="form-control" name="po_no" id="po_no">
                                    ...
                                    <tr><td align="right">Site Name</td><td align="left"><input type="text" value="<?php echo $r['site_name'];?>" required class="form-control" name="site_name" id="site_name"></td>
                                        ...
                                        <td align="right">Req.Ref.No</td><td><input type="text" name="req_ref" value="<?php echo $r['req_ref'];?>" required class="form-control" onblur="showHint22(this.value)"></td>
                                        </tr>
                                         
                                        <tr><td align="right">Seeking Opco</td><td align="left"><input type="text" value="<?php echo $r['seeking_opt'];?>"  class="form-control" name="seeking_opt" id="seeking_opt"></td>
...
<button type="button" class='btn btn-danger delete'>-</button>
											...
											<?php   //$id=count($_POST['id']);
											 $aa="select * from add_gbill where id1='$id'";
 ...
 from add_bill b,products a where b.service_no='$service_no' and b.item_code=a.item_code";*/
						...
						<input type="text" name="cgstamt[]" value="<?php echo $rs1['cgstamount']; ?>" style="width:60px;" readonly class="txt51" id="cgstamt<?php echo $i?>" />   
									...
									?>
										...
										<button class="btn btn-info" type="submit" name="update1" >
                                                <i class="ace-icon fa fa-save bigger-110"></i>
                                                Update
                                            </button>
										...
										<?php }?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="gabill_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">

                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="#">Gujrat Billing</a>
                            </li>
                            <li>
                                <a href="#">Upload Attachments</a>
                            </li>
                            ...
                            <div class="col-xs-6">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title">Upload Attachments</h3>
								</div>
                               
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="gupload_insert.php" enctype="multipart/form-data" autocomplete="off">
									...
									<div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Service No </label>

                                        <div class="col-sm-9">
                                           <input type="text" class="form-control" id="serviceno" name="serviceno" readonly required value="<?php echo $_GET['id'];?>"  /> 
                                        </div>
								   ...
								   <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Upload </label>
...
$(".addmore").on('click',function(){
    ...
    data +="<label class='control-label col-sm-2' for='fname'><input type='checkbox' class='case'/>Upload:</label>";

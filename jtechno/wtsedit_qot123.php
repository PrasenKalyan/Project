...
<div class="row">
 ...
 <input type="hidden" name="ids" value="<?php echo $id?>">
  <input type="hidden" name="ses" value="<?php echo $name;?>">
										...
										id="adv_amnt"  class="form-control" onkeyup="myFunction()" value="<?php echo $r['adv_amnt'];?>"></td>	
...
?>	
										...
										id="adv_amnt1"  class="form-control" onkeyup="myFunction()" value="<?php echo $r['adv_amnt1'];?>"></td>	
...
?>	
										...
										id="adv_amnt2"  class="form-control" onkeyup="myFunction()" value="<?php echo $r['adv_amnt2'];?>"></td>	
...
<button type="button" class='btn btn-danger delete'>-</button>
						...
						<input type="hidden" name="serv_code[]" value="<?php echo $rs1['serv_cap']; ?>" style="width:50px;" class="" id="serv_code<?php echo $i?>" />	   
									...
									?>
                                        <tr><td colspan="9" align="right"><strong>NET AMOUNT</strong></td>
										<td>

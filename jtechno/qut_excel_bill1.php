...
header("Content-Disposition: attachment; filename=".$quet_num." ".$city." ".BSP.".xls");
...
?>
   ...
   <!-- style="width:100%;height:120px;"-->
    ...
    <table><tr><td>
   <img src="http://softdemo.in/jyothi/images/exel_logo.jpg" style="width:100%;height:120px;"/></td></tr>
   
   <tr><td><br></td></tr><tr><td><br></td></tr><tr><td><br></td></tr><tr><td><br><br></td></tr>
   </table>
    <table border='1'  cellpadding="0" cellspacing='0'>
        
       
        <tr style="background-color:#eeece1; "><td colspan="12" style="text-align:center;font-size:18px;border:0px; background-color:#eeece1; "><b>BILL OF SUPPLY</b></td></tr>
        <tr><td colspan="12"><fieldset style="    border-right: 1px groove;    border-left: 0px;    border-top: 0px;
    border-bottom: 0px;">
  <?php $id=$_GET['id'];
$sq=mysqli_query($link,"select * from add_qot2 where id='$id'");
$r=mysqli_fetch_array($sq);
...
<table  width="100%" style="border:1px solid !important; border-right:1px solid !important;  ">
		  ...
		  <tr><td colspan="6"><b>Vendor GSTIN :	36APSPS9687Q1Z5</b></td>
		  <td colspan="6">Vendor State Code : <?php echo  $state_code ?></td>
		  </tr></table>
	<table width="100%" style="border:1px solid !important; border-top:0px !important;" >
<tr><td  colspan="6"><b>Bill No:</b><?php echo $r['quet_num'];?>

<?php $d=$r['inv_date']; // date('d-m-Y', strtotime($d));
?></td>
<td colspan="6"><b>Bill Date:</b><?php $d=$r['inv_date']; echo date('d-m-Y', strtotime($d));?></tr>
<!--
...
<table  width="100%" ><tr>
<td colspan="12" style="background-color:#b8cce4; " align="center"><b>Bill to Party</b></td>
...
<table  width="100%" ><tr>
<td colspan="12" style="background-color:#b8cce4; " align="center"><b>Ship to Party</b></td>
...
$i++; }
 ...
 <tr>
	<th  colspan="11" style="background-color:#eeece1;"> SGST/UGST Amt (In Rs)</th>
...
<tr>
	<th  colspan="11" style="background-color:#eeece1;"> CGST Amt (In Rs)</th>
 ...
 <tr>
	<th  colspan="11" style="background-color:#eeece1;"> IGST Amt (In Rs)</th>
	...
	<tr>
	<th  colspan="11" style="background-color:#eeece1;"> Total GST  (In Rs)</th>
	...
	<th style="width:120px;"><?php echo $tx1;?></th>
		...
		<tr>
	<th  colspan="11" style="background-color:#eeece1;"> Total Amount (In Rs)</th>

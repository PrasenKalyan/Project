...
function showUser(str,id)
{
    ...
    // document.getElementById("remarks"+id).value=strar[8];
...
//    data +="<td> <input type='text' name='remarks[]' required  data-row='"+i+"'  value='' style='width:80px;' class=''   id='remarks"+i+"' /></td>"; 
   	...
   	data +="<td><input type='hidden' name='productcode[]' data-row='"+i+"' value='' style='width:60px;' readonly class='' id='productcode"+i+"' /> </td>";    

...
<!--<td class="center">
                                                    ...
                                                    <td class="hidden-480">
                                                      <a href="tgedit_tgqot.php?id=<?php echo $rs1['id']; ?>">
...
echo "<li><a href='tgsupervisor.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='tgsupervisor.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

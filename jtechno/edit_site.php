...
$srtype=$_POST['srtype'];
$qry=mysqli_query($link,"update sites set indusid='$indusid',customer='$customer',cust_site_id='$custid',sitename='$sitename',district='$district',towertype='$towertype',srtype='$srtype'  where id='$sid'");
if($qry){
            print "<script>";
    ...
    $id=$_GET['id'];
    $p=mysqli_query($link,"select * from sites where id='$id'") or die(mysqli_error($link));
...
?>
 ...
 <form name="frm" method="post" id="register-form" action="">
										 ...
										 <input type="text" name="indusid" id="indusid" value="<?php echo $p1['indusid'] ?>" required class="form-control"></td>
                                           <td align="right">Customer</td><td>
                                          <input type="text" name="customer" id="customer" required value="<?php echo $p1['customer'] ?>" class="form-control">
                                        <input type="hidden" name="sid" id="sid" required value="<?php echo $p1['id'] ?>" class="form-control">
                                       </td></tr>
                                        
                                        <tr>
                                         <td align="right">Customer Site Id</td><td>
                                        <input type="text" name="custid" id="custid" required value="<?php echo $p1['cust_site_id'] ?>" class="form-control">
                                        
                                       </td>
                                        <td align="right">Site Name</td><td>
                                        <input type="text" name="sitename" id="sitename" required value="<?php echo $p1['sitename'] ?>" class="form-control">
                                        ...
                                        <input type="text" name="district" id="district" value="<?php echo $p1['district'] ?>" required class="form-control">
                                        
                                       </td>
                                        <td align="right">Tower Type</td><td>
									<input type="text" name="towertype" id="towertype" value="<?php echo $p1['towertype'] ?>" required class="form-control">
                    				 ...
                    				 <tr>
                                        ...
                                        <input type="text" name="srtype" id="srtype"  value="<?php echo $p1['srtype'] ?>"  class="form-control">

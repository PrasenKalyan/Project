...
$qtno=$_GET['id'];
$yk="select * from knqot_bill where quet_num='$qtno'";
...
$y="select * from add_knqot where quet_num='$qtno'";
...
$y1="select * from add_knqot1 where id1='$id1'";
...
header('Content-Disposition: attachment;filename="kninvoice'.$qtno.'.xlsx"'); //tell browser what's the file name

...
include'dbfiles/uqry_section.php';
?>
<!DOCTYPE html>
<html lang="en">
                               ...
                               <div class="box box-info">
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action=""  autocomplete="off">
								   ...
								   <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="cname" name="cname" required placeholder="Enter Section Name" value="<?php echo $sname;?>"  /> 
...
<td class="center">
                                                        ...
                                                        <td>
                                                            <div class="hidden-sm hidden-xs action-buttons">
                                                                ...
                                                                <a href="editsection.php?id=<?php echo $rs1['id']; ?>"  class="data green"  > <i class="ace-icon fa fa-pencil bigger-130"></i></a>
                                                                <a class="red" href="dbfiles/deletesection.php?id=<?php echo $rs1['id'];  ?>" onclick="return ConfirmDialog();">

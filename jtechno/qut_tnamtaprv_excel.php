...
$objPHPExcel->getActiveSheet()->SetCellValue('T6', 'Whom to be Invest Amount');
$objPHPExcel->getActiveSheet()->SetCellValue('U6', 'Request Amount');
$objPHPExcel->getActiveSheet()->SetCellValue('V6', 'Rq Amount Date');
...
while($row	=	$result->fetch_assoc()){
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('T'.$rowCount, mb_strtoupper($ac,'UTF-8'));
    ...
    $row4=$result3->fetch_assoc(); 
  	$objPHPExcel->getActiveSheet()->SetCellValue('U'.$rowCount, mb_strtoupper($row4['req_amnt'],'UTF-8'));
	$objPHPExcel->getActiveSheet()->SetCellValue('V'.$rowCount, mb_strtoupper(date('d-m-Y',strtotime($row['req_date'])),'UTF-8'));

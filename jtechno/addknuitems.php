                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="#">Add KN Material Description</a>
                            </li>
...
<div class="row">
 ...
 <form name="frm" method="post" id="register-form" action="knuitems_suc.php">
									...
									<option value="No">No</option>
                                        ...
                                        <div class="col-md-offset-4 col-md-8">
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="knuploaditems_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">

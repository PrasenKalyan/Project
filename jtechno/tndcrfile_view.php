                ...
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-header">
                            <h1 align="center">
                              TN  Mark Not Required File View
                            </h1>
                        </div>
  ...
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
									...
									<input type="hidden" name="id1" 
										...
										$qt_no=$_POST['qt_no'];
												...
												$sq=mysqli_query($link,"update  tnrequest_amnt set docr_status='$status' where id='$id'");
											 	$yt="update add_tnqot set status='Not Required'  where quet_num='$qt_no'";
                                                if($status=="approved"){
			...
			print "self.location='tnwork1.php';";
			print "</script>";
										}
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="tnwork1.php"><button class="btn btn-danger" type="button" name="button" id="Close">

...
if (isset($_POST['submit'])) {
    $photoFullPath = "http://localhost/jtechno/";
    //reading form data
   ...
   if($iname!= ""){
	...
	$insertempimg1="update emp set photo='$empPath' where empid='$last_id' ";
 
    $insertempimgres = mysqli_query($link, $insertempimg1) or die("could not connected" . mysqli_error($link));
...
echo $x="insert into employee(emp_name,DOB,gender,maritalstatus,contactno,alternateno,adharcardno,address,city,state,qualification,experience,
 ...
 '$DOJ','$designation','$ESI_NO','$PFNO','$photo',' $fileName15','$emp_email','$username','$password','$user','$strcd')";

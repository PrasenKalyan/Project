        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <div class="main-content">
                <div class="main-content-inner">
                 ...
                 <?php  $id=$_GET['id'];
						$sq=mysqli_query($link,"select * from tnpayment where id='$id'");
...
<div class="row">
 ...
 <form name="frm" method="post" action="">
						...
						<tr><td align="right">Remarks</td><td align="left">
										...
										if(isset($_POST['update'])){
											...
											$bill_date1=$_POST['bill_date1'];
												...
												$pp="update tnpayment set document_num1='$qt_no1',remarks='$remarks', recevied_amnt1='$paid',recevied_date1='$bill_date1',outstanding='$bal' where id='$id'";
											//exit;
			...
			print "</script>";
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="tnbill_list4.php"><button class="btn btn-danger" type="button" name="button" id="Close">

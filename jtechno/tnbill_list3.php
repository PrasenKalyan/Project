...
<div class="row">
                ...
                <input type="text" class="form-control pull-right" id="myInput" name="search" placeholder="Search By Quotation Name No  " onkeyup="myFunction()">
                  ...
                  <div class="col-sm-2"><b><a href="qut_tnpp_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
			<!--	   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                   ...
                                   <div style="overflow-x:auto;">     
											...
											$ssq1="select * from tnqot_bill where status='Un Paid' ";
													  } else {
													     if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='tnbilling') or ($tsname=='sumanthpotluri')){
													           $ssq1="select * from tnqot_bill where status='Un Paid' ";
													      }else{
													           $ssq1="select * from tnqot_bill where status='Un Paid' and user='$tsname' ";
													      }
											...
											while($rs1=mysqli_fetch_array($t)){
                                                   ...
                                                   <th><?php echo $rs1['user']; ?></th>
                                                     <td class="hidden-480">
                                                         ...
                                                         <a href="tnedit_req_bill3.php?id=<?php echo $q; ?>&id1=<?php echo $net;?>&q=<?php echo $q?>">
														...
														<?php }?>
														    ...
														    $tp=mysqli_query($link,"select file from tnqot_bill where id='$tgid'") or die(mysqli_error($link));
														    ...
														    <?php }?>
														     ...
														     <?php if(($tsname=='admin')){ ?>
														    <td>
														         <a href="tnupload_req_bill.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/edit.gif"></a>

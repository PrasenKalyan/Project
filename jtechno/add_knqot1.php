...
xmlhttp.open("GET","get-kndata4.php?q="+str,true);
xmlhttp.send();
}
</script>
            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <?php $id=$_GET['id'];
						$sq=mysqli_query($link,"select * from add_knbill1 where id='$id'");
...
?>
											  ...
											  <input  type="text"  class="form-control" value="QJISKN<?php echo $cnt;?>" readonly required name="qt_no" id="qt_no"></td>

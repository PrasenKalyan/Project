...
<?php  
$sql="SELECT distinct store_code FROM add_odqot";
...
<?php  
$sql="SELECT distinct a.store_name FROM add_odqot b,dpr a where b.store_code=a.store_code";
  // Query to collect records
$r=mysqli_query($link,$sql) or die(mysqli_error());
while ($row=mysqli_fetch_array($r)) {
...
<?php  
$sql="SELECT distinct a.coordinator FROM add_odqot b,dpr a where b.store_code=a.store_code";
  // Query to collect records
$r=mysqli_query($link,$sql) or die(mysqli_error());
while ($row=mysqli_fetch_array($r)) {
...
<?php  
$sql="SELECT distinct a.superwisor FROM add_odqot b,dpr a where b.store_code=a.store_code";
  // Query to collect records
$r=mysqli_query($link,$sql) or die(mysqli_error());
while ($row=mysqli_fetch_array($r)) {
...
<?php  
$sql="SELECT distinct a.city FROM add_odqot b,dpr a where b.store_code=a.store_code";
  // Query to collect records
$r=mysqli_query($link,$sql) or die(mysqli_error());
while ($row=mysqli_fetch_array($r)) {
...
<?php  
$sql="SELECT distinct status FROM add_odqot ";
  // Query to collect records
$r=mysqli_query($link,$sql) or die(mysqli_error());
while ($row=mysqli_fetch_array($r)) {
...
echo "<li><a href='odsupervisor.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='odsupervisor.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

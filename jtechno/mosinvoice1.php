...
<td>'.$service_no.'<br/>'.$invdate.'<br/>Maharasthra<br/>27</td>
</tr>
</table>
</td>
<td  style="width:48%;">
...
<td>PAN No:-AAACO8174A<br/>GST NO:-36AAACO8174AIZM</td>
 ...
 <table >
		  ...
		  <tr>
			...
			State :'.$state.',<br/>
			Wcc Period :'.$wcc_pf.',<br/>
			Wcc Period :'.$wcc_tf.',<br/>
			'; 
...
<th  style="text-align:center;width="250px;">ITEM DESCRIPTION</th>
<th style="text-align:center;width="60px;">HSN/SAC No</th>
<th style="text-align:center;width="40px;">UNIT</th>
<th style="text-align:center;width="30px;">Qty</th>
<th style="text-align:center;width="40px;">RATE</th>
<th style="text-align:center;width="50px">TAXABLE AMOUNT</th>
...
<th >' . $hsn . '</th>
<th style="width:40px;">' . $rows['uom'] . '</th>
<th style="width:40px;text-align:center;">' . $rows['qty'] . '</th>
<th style="width:60px;text-align:center;">' . $rows['price'] . '</th>
<th style="width:60px;">' . $rows['tax_amnt'] . '</th>

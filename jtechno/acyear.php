                        ...
                        <div class="row">
                            <div class="col-xs-6">
                               <div class="box box-info">
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="acyear_suc.php" enctype="multipart/form-data" autocomplete="off">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                        ...
                                        <div>
											...
											if(isset($_POST['bsearch'])){
											 ...
											 $y="select * from products where item_code like  '%$bsearch%' or item_desc like  '%$bsearch%' ";
...
<td class="center">
                                                        ...
                                                        <?php if($name=='admin'){?>
                                                         <td>
														 <a href="edit_prd.php?id=<?php echo $rs1['id'];?>"><img src="images/edit.gif"></a>
														 <a href="delete_prd.php?id=<?php echo $rs1['id'];?>"><img src="images/Icon_Delete.png"></a>
														 </td>
                                                       <?php }?>
...
$start_from = ($page-1) * $results_per_page;
                                                   ...
                                                   // $q="select * from products order by id desc limit 1000";
...
echo "<li><a href='acyear.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='acyear.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

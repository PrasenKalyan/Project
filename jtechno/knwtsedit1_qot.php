        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <div class="main-content">
                <div class="main-content-inner">
                  ...
                  <?php  $qtno=$_GET['id'];
                  $k=mysqli_query($link,"select id from knrequest_amnt where quet_num='$qtno'") or die(mysqli_error($link));
while($k1=mysqli_fetch_array($k)){
$klarray[]=$k1['id'];
}

						$sq=mysqli_query($link,"select * from add_knqot where quet_num='$qtno'");
...
<div class="row">
 ...
 <form name="frm" method="post" action="knwtsqot1_suc.php" enctype="multipart/form-data">
											...
											<?php   $id=count($_REQUEST['id']);
										     ...
										     $aa="select * from add_knqot1 where id1='$id1'";
												...
												while($rs1=mysqli_fetch_array($sq)){
													...
													<a onclick="return confirm('Are you sure you want to delete this item?');" href='delete_knine.php?id=<?php echo $rs1['id']; ?>&id1=<?php echo $rs1['id1'];?>'><input type="button" class="btn btn-danger" value="Delete"></button>
							</a>
							<?php }?>

                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="tnbill_list.php"> Document List</a>
                            </li>
                            <li>
                  ...
                  <?php  $qtno=$_GET['id'];
                  $k=mysqli_query($link,"select id from tnrequest_amnt where quet_num='$qtno'") or die(mysqli_error($link));
while($k1=mysqli_fetch_array($k)){
$klarray[]=$k1['id'];
}

						$sq=mysqli_query($link,"select * from add_tnqot where quet_num='$qtno'");
...
$reason=$_POST['reason'];
		    ...
		    $v="update add_tnqot set status='work to be started',
...
gst_amount2='0.00',gst_amount3='0.00',gst_amount4='0.00',reason='$reason',doctoworkrevertfile='$iname1'		
	...
	$sq=mysqli_query($link,$v) or die(mysqli_error($link));
											 ...
											 echo	$dd="delete from tnrequest_amnt where quet_num='$qt_no'";

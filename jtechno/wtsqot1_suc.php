...
if($adv_amnt3 > 0 or $gst_amount3 >0){
	...
	$ssq2=mysqli_query($link,"insert into ".$request_amnt."(quet_num,req_amnt,req_date,user,state,ac_det,confirm,gstamt,gsttype)
	values('$qt_no','$adv_amnt3','$adv_date3','$ses','$state','$ac_det4','Pending','$gst_amount3','$gst_type3')");
}
...
if($adv_amnt4 > 0 or $gst_amount4 >0){
	...
	$ssq2=mysqli_query($link,"insert into ".$request_amnt."(quet_num,req_amnt,req_date,user,state,ac_det,confirm,gstamt,gsttype)
	values('$qt_no','$adv_amnt4','$adv_date4','$ses','$state','$ac_det5','Pending','$gst_amount4','$gst_type4')");
}
		    ...
		    $v="update ".$qottable." set status='Document Required',

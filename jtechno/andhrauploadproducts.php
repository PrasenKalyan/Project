                            ...
                            <div class="col-xs-6">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title">Upload Items</h3>
								</div>
                               
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="andhraupload_suc.php" enctype="multipart/form-data" autocomplete="off">
...
<div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS -->
                                <div class="row">
                                   <a href="addapproducts.php"><button type="button" class="btn-success btn-sm ">Add New</button></a>
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                        ...
                                        <div>
											...
											if(isset($_POST['bsearch'])){
											 ...
											 $y="select * from approducts where item_code like  '%$bsearch%' or item_desc like  '%$bsearch%' ";
...
<td class="center">
                                                        ...
                                                        <td class="hidden-480"><?php echo $rs1['item_category']; ?></td>
                                                         ...
                                                         <td>
														 <a href="edit_apprd.php?id=<?php echo $rs1['id'];?>"><img src="images/edit.gif"></a>
														  <a href="delete_apprd.php?id=<?php echo $rs1['id'];?>"><img src="images/Icon_Delete.png"></a>
														 </td>
...
echo "<li><a href='andhrauploadproducts.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='andhrauploadproducts.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

			...
			<!--	   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                        ...
                                        $start_from = ($page-1) * $results_per_page;
											...
											$y="SELECT * FROM qot_bill where   quet_num like  '%$bsearch%'  ";
											} else {
											    
											      if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='apbilling')){
											    
													 $y="SELECT * FROM qot_bill where     inv_num!=''  order by id asc  LIMIT $start_from,$results_per_page  ";
											      }else{
											         $y="SELECT * FROM qot_bill where status='payment pending' and inv_num!='' and user='$tsadmin'  order by id asc  LIMIT $start_from,$results_per_page ";
											    }

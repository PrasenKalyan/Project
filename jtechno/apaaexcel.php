                ...
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-header">
                            <h1 align="center">
                            <?php echo $state; ?> Amount Approved Excel
                            ...
                            <div class="col-xs-6">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title"> <?php echo $state; ?> Amount Approved Excel</h3>
								</div>
                               
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="qut_apamtaprvfromtodate_excel.php?state=<?php echo $state; ?>"  autocomplete="off" target="_blank">

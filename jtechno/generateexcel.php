...
$objPHPExcel->getActiveSheet()->setCellValue('I12', $r1['state_code']);	
...
$objPHPExcel->getActiveSheet()->setCellValue('c16', $address);
$objPHPExcel->getActiveSheet()->setCellValue('c19', $pan);
$objPHPExcel->getActiveSheet()->setCellValue('c20', $gst);
$objPHPExcel->getActiveSheet()->setCellValue('C21', $state);
$objPHPExcel->getActiveSheet()->setCellValue('C22',  $month1.' '.$year1); 

$objPHPExcel->getActiveSheet()->setCellValue('E21',  $r1['state_code']);
...
include_once('dbconnection/connection.php');
 $aa="select  @acount:=@acount+1 sno,gst,hsn,serv_code,desc1,brand,model,qty,uom,rate,base_amt,serv_amt,(base_amt+serv_amt) as total,gst_amnt  from (SELECT @acount:= 0) AS acount,".$qottable1." where  id1='$bid' ";

                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="knqot_list.php"> Document Required List</a>
                            </li>
                            <li>
...
<div class="row">
 ...
 <input type="hidden" name="ids" value="<?php echo $id?>">
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
										...
										<input type="file" name="image" required id="image" class="form-control"/></td>	
	...
	$iname1 = ($iname1);
	 ...
	 $iname1 = ($img1);
												...
												$sq=mysqli_query($link,"update  knrequest_amnt set gstatus='pending',gstfile='$iname1' where id='$id'");
			...
			print "</script>";
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="knwork2.php"><button class="btn btn-danger" type="button" name="button" id="Close">

...
<div class="row">
 ...
 <form name="frm" method="post" action="qot_posuc.php" enctype="multipart/form-data">
  ...
  <input type="hidden" name="ses" value="<?php echo $name;?>">
											...
											<tr>
											    ...
											    <td><input  type="text"   class="form-control" value="" required name="po_no" id="po_no"></td>
											     <td align="right">PO Date</td>
											     <td><input type="date" value="<?php echo date('Y-m-d');?>"  required name="po_date" id="po_date" class="form-control"></td>
											</tr>
											  <tr><td align="right">Shipment  Date</td>
											     <td><input type="date" value="<?php echo date('Y-m-d');?>"  required name="s_date" id="s_date" class="form-control"></td>
											
											  
                                       <td align="right">Seller Quot Ref:</td>
											    <td><input  type="text"   class="form-control" value="" required name="sqo_no" id="sqo_no"></td>
                                        </tr>
											
                                            <tr>
											
											<td align="right">Seller Quot Date</td>
											     <td><input type="date" value="<?php echo date('Y-m-d');?>"  required name="sqo_date" id="sqo_date" class="form-control"></td>
											
                                      
											
											<td align="right">To Address</td><td align="left">
										<textarea  required name="to_add" id="to_add" class="form-control" rows="4" cols="50"></textarea></td>
</tr>
                                        
                                        <tr><td align="right">Attention:</td><td align="left">
										 <input  type="text" value=""  class="form-control" name="atten" id="atten"></td>
                                        <td align="right">Contact No</td><td><input type="text"  name="cono" id="cono" class="form-control"></td>
                                        </tr>
                                        
										
										 <tr><td align="right">To Address GSTIN:</td><td align="left">
										 <input  type="text" value=""  class="form-control" name="togst" id="togst"></td>
                                        	<td align="right">Delivery Address</td><td align="left">
										<textarea  required name="del_add" id="del_add" class="form-control" rows="4" cols="50"></textarea></td>
                                        </tr>
										
										
										 <tr><td align="right">Delivery Address GSTIN:</td><td align="left">
										 <input  type="text" value=""  class="form-control" name="del_gst" id="del_gst"></td>
                                       <td align="right">Name of Contact Person:</td><td>
										<input type="text" required name="conname" id="conname" class="form-control"></td>
                                        </tr>
										
                                         <tr><td align="right">Contact Person No.</td><td align="left">
										<input type="text" required name="conno" id="conno" class="form-control"></td>
                                          <td align="right">Seller Title date</td>
                                          <td><input type="date" value="<?php echo date('Y-m-d');?>"  required name="st_date" id="st_date" class="form-control"></td>
                                        </tr>
...
data +="<td><input type='text' name='pname[]'  id='pname"+i+"' data-row='"+i+"' style='width:300px;' class='form-control pname"+i+"'  > <div id='suggesstion-box"+i+"'></div>";
data +="</td>";
...
//data +="<td><input type='text' name='serv_num[]' data-row='"+i+"' value='' style='width:60px;'  class='' id='serv_num"+i+"' /> </td>";          
  //data +="<td><input type='text' name='brand[]' required  value='' style='width:50px;'  id='brand"+i+"' />	   </td>";
	  ...
	  data +="<td><input type='text' name='hsn[]'  value='' style='width:80px;'  id='hsn"+i+"' />	   </td>";
...
data +="<td><input type='text' name='amnt[]' data-row='"+i+"' value='' style='width:60px;'  class='txt tx6'readonly id='amnt"+i+"' /> </td>";          

...
<content>
  <table border='1'  cellpadding="0" cellspacing='0'>
       <thead>
            <tr class="noBorder" ><th   colspan="14"style="padding-top:158px;border-right:none !important;font-size:18px;"></th></tr>
        </thead>
        <tfoot >
            <tr class="noBorder " style="border-color:#fff;border-left-color:#fff;"><th class="noBorder " colspan="14" style="padding-top:130px;"></th></tr>
        </tfoot>
...
<table width="500" style="font-weight: 550;font-size: 14px;">
<tr>
...
$i++; }
 ...
 <th style="font-size:16px;  border-right-color: #000 !important;"> <?php echo $tamt=round($tax_amnt+$gst,2); ?></th>
 </tr>

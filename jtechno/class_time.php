...
<select name="acdyear" class="form-control" required>
	...
	<?php
		$Academic_Year=$_POST['class1']; 
	     $Admission_Date=$_POST['section'];		
		$Admission_No=$_POST['medium']; 	



	  
							  $ss="SELECT * FROM  class  where id='$Academic_Year'";
							  ...
							  $ss="SELECT * FROM  section  where id='$Admission_Date'";
							  $sql=mysqli_query($link,$ss);
							  $re=mysqli_fetch_array($sql);
            ...
            $sq=mysqli_query($link,"SELECT * FROM  time_table1 where class='$Academic_Year'&& section='$Admission_Date'&& medium='$Admission_No'");
			echo "$cname";
			echo "-";
			echo " $sname";
			echo "-";
...
<tr>
<td><b><?php echo strtoupper($row['day']); ?></b></td>

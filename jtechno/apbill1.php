    ...
    $("#register-form").validate({
        ...
        rules: {
            ...
            service_no: {
					   ...
					   remote: "apemailcheck1.php?data=service_no"
					},
			...
			wcc_num:{
					 ...
					 remote: "apemailcheck1.php?data=wcc_num"
				  ...
				  wcc_rec_num:{
					 ...
					 remote: "apemailcheck1.php?data=wcc_rec_num"
...
xmlhttp.open("GET","get-apdata1.php?q="+str,true);
xmlhttp.send();
}
</script>
<script>
...
<div class="row">
 ...
 <form name="frm" method="post" id="register-form" action="apbill_suc.php">
...
<?php 
$sql="select distinct req_ref from aprefferences ";  // Query to collect records
...
echo "</datalist>";?></datalist>
										...
										$rt=mysqli_query($link,"select * from apbill where id='$uid'") or die(mysqli_error($link));
...
<button type="button" class='btn btn-danger delete'>-</button>
										...
										$y1="select distinct a.line,a.itemdesc,a.uom,a.price,a.qty,a.amount,b.item_code,b.hsn,b.sac,b.cgst,b.sgst,b.igst from  apbill1 a left join approducts b  on a.itemdesc=b.item_desc  where  a.id1='$uib' order by a.uid asc";

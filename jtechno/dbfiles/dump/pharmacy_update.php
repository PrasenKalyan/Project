...
if(empty($lwebsite)){
   ...
   if($labname!='' and $address!='' and $labtin1!='' and $labtin2!='' and $email!='' and $phone!='' and $mobile!='' and $lwebsite!='') {
          $sql = "update pharmacydetails set lab_name='$labname',lab_address='$address',lab_email='$email',lab_phone='$phone',lab_mobile='$mobile',lab_url='$lwebsite',lab_tin1='$labtin1', lab_tin2='$labtin2' where id='$id'";
...
//if it is successfully update then display alert box in form
    ...
    $sql1 = "select * from pharmacydetails where id='1'";

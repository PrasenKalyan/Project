...
if (isset($_POST['submit'])) {
    ...
    $caste = trim($_POST['acyear']);
   $user=trim($_POST['user']);
   

 $res = mysqli_query($link, "insert into caste(caste_name,user) values('$caste','$user')") or die("could not connected" . mysqli_error());
...
//if it is successfully update then display alert box in form
       print "<script>";
        ...
        print "self.location='addcaste.php';";
        print "</script>";
    }

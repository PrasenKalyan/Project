...
xmlhttp.open("GET","getfilterinforpages.php?q="+str+"&statetable=add_tnqot",true);
xmlhttp.send();
}
...
<!--<td class="center">
                                                ...
                                                if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='sumanthpotluri') or ($tsname=='manikandan')){ ?>

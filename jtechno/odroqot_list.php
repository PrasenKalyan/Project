...
<!--<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_odqot.php'" id="bsearch">   Add New  </button>
		...
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
				  ...
				  <div class="col-sm-2"><b><a href="qut_odro_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
...
$start_from = ($page-1) * $results_per_page;
											...
											// $y="select * from add_odqot where (quet_num like '%$bsearch%' or falt_no like '%$bsearch%') or status like '%$bsearch%'order by id desc";
											 $y="select * from add_odqot where (quet_num like '%$bsearch%' or falt_no like '%$bsearch%') and status = 'Ro Required' order by id desc";
												} else
...
$r1=mysqli_fetch_array($ssq1);
                                                    ...
                                                    <td class="hidden-480"><a href="odroedit_qot.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/edit.gif"></a></td>
														 <td class="hidden-480"><a onclick="return confirm('Are you sure you want to send the Email?');" href="odemail.php?id=<?php echo $rs1['id'];?>&name1=<?php echo $r1['coordinator'];?>&name2=<?php echo $r1['superwisor'];?>"
												   class="">
...
echo "<li><a href='odroqot_list.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='odroqot_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

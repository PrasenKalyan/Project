...
//header("Content-Disposition: attachment; filename=QUOTATION DOWNLOAD".date('d-m-Y').".xls");
...
?>
   ...
   <!-- style="width:100%;height:120px;"-->
    ...
    <table border='1'  cellpadding="0" cellspacing='0'>
        <thead>
            <tr class="noBorder" ><th   colspan="14"style="padding-top:20px;border-right:none !important;font-size:18px;"></th></tr>
        </thead>
        <tfoot>
        ...
        <tr style="background-color:#CCC; "><td colspan="14" style="text-align:center;font-size:18px;border:0px; background-color:#CCC; "><b>QUOTATION</b></td></tr>
...
<div style="border:0px solid #000;">
 <table >
		...
		<b>	Name of Vendor :<br/>
		  ...
		  <td>Vendor State Code : <?php  $st=$r1['state_code']; if($st!=''){ echo $st; } else { echo "-";} ?></td></tr></table>

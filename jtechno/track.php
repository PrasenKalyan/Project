                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="#"><?php echo $state; ?> Reports</a>
                            </li>
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-header">
                            <h1 align="center">
                            <?php echo $state; ?> Tracker Sequence
                            ...
                            <div class="col-xs-6">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title"><?php echo $state; ?> Tracker Sequence</h3>
								</div>
                               
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="aptrack_excel.php?state=<?php echo $state; ?>"  autocomplete="off" target="_blank">

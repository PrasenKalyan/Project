 ...
 <input type="hidden" name="ids<?php echo $i; ?>" value="<?php echo $id1?>">
  <input type="hidden" name="ses" value="<?php echo $name;?>">
                                       ...
                                       <td align="right">Total Request Amount</td><td align="left">
										...
										<td align="right">Remarks</td><td><input type="text" name="remarks" 
							...
							echo $dd="update tnrequest_amnt set confirm='$confirm',approve_amnt='$approve_amnt1',remarks='$remarks' where id='$id'";
	...
	if(isset($_POST['update2'])){
							...
							echo $dd="update tnrequest_amnt set confirm='$confirm',approve_amnt='$approve_amnt2',remarks='$remarks' where id='$id2'";
							$ssq=mysqli_query($link,$dd);
			...
			print "</script>";
							...
							echo $dd="update tnrequest_amnt set confirm='$confirm',approve_amnt='$approve_amnt3',remarks='$remarks' where id='$id3'";
							$ssq=mysqli_query($link,$dd);

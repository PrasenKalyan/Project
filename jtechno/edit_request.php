                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="#"><?php echo $state;?> Request Amount Approve  </a>
                            </li>
                            <li>
                                <a href="qot_list.php?state=<?php echo $state;?>"><?php echo $state;?>  Request Amount Approve </a>
                            </li>
                            <li>
 ...
 <input type="hidden" name="ids<?php echo $i; ?>" value="<?php echo $id1?>">
  <input type="hidden" name="ses" value="<?php echo $name;?>">
                                       ...
                                       <td align="right">Total Request Amount</td><td align="left">
										...
										<?php $idd=$r1['id'];?>
										<tr><td align="right" colspan="2">Qutation Print(Click Print Button to view Qutation Print)  
											 <?php if($state=='AP' or $state=='TG' or $state=='KL' or $state=='TN' or $state=='KN' or $state=='OD'){ ?>
										...
										<button class="btn btn-info" type="submit" name="update<?php echo $i; ?>" id="submit">
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="req_list.php?state=<?php echo $state;?>"><button class="btn btn-danger" type="button" name="button" id="Close">
							...
							$ssq=mysqli_query($link,$dd);
								...
								mysqli_query($link,"update ".$qottable." set status='Approved Amount' where quet_num='$qt_no'") or die(mysqli_error($link));
							print "<script>";

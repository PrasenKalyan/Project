...
<div class="row">
 ...
 <form name="frm" method="post" action="sampleqot_suc.php" enctype="multipart/form-data">
 <input type="hidden" name="id" value="<?php echo $id?>">
  <input type="hidden" name="ses" value="<?php echo $name;?>">
                                            <table class="table table-striped table-bordered table-hover">
											<tr>
											    <td align="right">Quote No</td>
											    <td><input  type="text"   class="form-control" value="QJISAP<?php echo $cnt;?>" required name="qt_no" id="qt_no"></td>
											    <td align="right">Manual Quote</td>

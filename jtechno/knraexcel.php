                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="#">KN Requested Amount Tracker</a>
                            </li>
                            ...
                            <div class="col-xs-6">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title"> KN Requested Amount Excel</h3>
								</div>
                               
                                <form class="form-horizontal" method="GET" id="validation-form" role="form" method="post" action="qut_knreqamtfromtodate_excel.php"  autocomplete="off" target="_blank">

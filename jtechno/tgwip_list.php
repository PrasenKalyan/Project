...
<div class="row">
			...
			<!--	   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
										...
										if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='tgbilling')or ($tsname=='sumanthpotluri') or ($tsname=='naiduys') ){
...
echo date('d-m-Y', strtotime($d)); }?></td>
                                                        ...
                                                        <td class="hidden-480">
                                                            ...
                                                            <a href="tgedit_wip.php?id=<?php echo $rs1['quet_num']; ?>&id1=<?php echo $r1['id'];?>">

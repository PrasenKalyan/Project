                            ...
                            <div class="col-xs-6">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title"> TN Amount Approved Excel</h3>
								</div>
                               
                                <form class="form-horizontal" method="GET" id="validation-form" role="form" method="post" action="qut_tnamtaprvfromtodate_excel.php"  autocomplete="off" target="_blank">

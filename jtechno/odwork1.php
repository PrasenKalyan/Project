...
<div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
									...
									<!--<a href="addbill.php"><button type="button" class="btn-success btn-sm ">Add New</button></a>-->
                                     ...
                                     OD Mark Not Required Bills  List
                                        </div>
             ...
             <div class="col-sm-2"><b><a href="qut_odmark_excel.php?user=<?php echo $tsname;?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
            	</div> 
											...
											$yu=mysqli_query($link,"select * from add_odqot where quet_num='$quet_num'") or die(mysqli_error($link));
...
<!--<td class="center">
                                                    ...
                                                    <td><?php echo $r3['superwisor']; ?> </td>
                                                     <td><?php 
                                                     $uy=mysqli_query($link,"select sum(approve_amnt) as amt from odrequest_amnt where quet_num='$quet_num'") or die(mysqli_error($link));
													...
													<td class="hidden-480"><?php 
                                                        ...
                                                        <td><a href="oddcrfile_view.php?id=<?php echo $rs1['id'] ?>">View Fiie</a></td>
...
echo "<li><a href='odwork1.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='odwork1.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

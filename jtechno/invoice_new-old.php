...
<?php
 $y="select distinct(cgst) from add_bill where service_no='$service_no' ";
$sq=mysqli_query($link,$y) or die(mysqli_error($link));
 ...
 while($r=mysqli_fetch_array($sq)){
	 ...
	 $u="select  sum(tax_amnt) as tax_amnt,sum(gst_amnt) as gst from add_bill where service_no='$service_no' and cgst='$sggst'";

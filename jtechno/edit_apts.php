                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="dashboard.php"> Upload AP and TS Employees</a>
                            </li>
                            <li>
                                 <i class="ace-icon fa fa-edit home-icon"></i>
                                <a href="edit_apts.php"> Edit AP TS Employee</a>
                            </li>
...
include('dbconnection/connection3.php');
						$id=$_GET['id'];
						 $y="select * from register where id='$id' ";
											$t=mysqli_query($link4,$y) or die(mysqli_error($link4));
...
<div class="row">
 ...
 <form name="frm" method="post" id="register-form" action="sapts_suc.php">
                                       ...
                                       <tr> <td align="right">State </td><td>
										 <select name="state" id="state" required class="form-control">
										  ...
										  <option value="AP" <?php if($r['state']=="AP"){ echo 'selected';} ?>>AP</option>
										  <option value="TG" <?php if($r['state']=="TG"){ echo 'selected';} ?>>TG</option>

...
<center><h2><u>Gujarat Summery</u></h2></center>
<div >
    <table class="left" border="1">
      ...
      <tr>
      <?php $sq=mysqli_query($link,"select * from add_gbill1 where `date` between '$from' and '$to'");
	     $i=1;
	  while($r=mysqli_fetch_array($sq))
	  {
		$rf=$r['req_ref'];
		$t=mysqli_query($link,"select * from grefferences where req_ref='$rf'");

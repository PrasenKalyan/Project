...
$id=$_POST['id'];
   ...
   if($id1!='' and $id2!=''){
	  $query = "update add_gbill set `service_no`='$service_no', `item_code`='$item_code',item_desc='$item_desc', `price`='$price',uom='$uom',
...
$bar_code=$_POST['bar_code'];
	...
	$payment_doc_date=$_POST['payment_doc_date'];
	$payment_doc_no=$_POST['payment_doc_no'];
echo $v="update `add_gbill1` set qr_code='$bar_code',bill_submit_date='$sub_date',`payment_doc_date`='$payment_doc_date',`payment_doc_no`='$payment_doc_no', `bill_status`='Submited'  where id='$id'";

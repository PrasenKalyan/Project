                            ...
                            <div class="col-xs-6">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title"> AP & TS Upload Items</h3>
								</div>
                               
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="ubill_suc.php" enctype="multipart/form-data" autocomplete="off">

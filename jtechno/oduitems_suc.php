...
$s_code=$_POST['s_code'];	
	...
	$sq=mysqli_query($link,"INSERT INTO `oditems`(`mdescription`, `umo`, `hsncode`, `urate`, `gst`, 
	...
	print "self.location='oduploaditems_list.php';";
	print "</script>";
...
$s_fee=$_POST['s_fee'];
$s_code=$_POST['s_code'];		
	$sq=mysqli_query($link,"update  `oditems` set `mdescription`='$mdesc', `umo`='$umo', `hsncode`='$hsn',

...
include('dbconnection/connection.php');
 ...
 $p=mysqli_query($link,"select * from add_bill1 where id=' $id'") or die(mysqli_error($link));
...
$subject = "OSPS AP and TS Billing Invoice No".$sno;
...
$success = mail($to,$subject,$message,$headers);
  ...
  echo "Mail to " . $to . " failed .";
         ...
         unlink($doc);
        header('Location:apbill_list.php');

...
include'dbfiles/uqry_cordination.php';
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="#">Co-Ordination Details</a>
                            </li>
                               ...
                               <div class="box box-info">
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action=""  autocomplete="off">
								   ...
								   <div class="form-group">
									 ...
									 <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Co-Ordination Email </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-4 col-md-8">
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="coordination.php"><button class="btn btn-danger" type="button" name="button" id="Close">

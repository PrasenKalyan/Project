                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="#">KN Work in Progress List</a>
                            </li>
                            <li>
...
<div class="row">
			...
			<!--	   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
										...
										if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='klbilling') or ($tsname=='sumanthpotluri')or ($tsname=='rajesh.p')or ($tsname=='naiduys')){
...
echo date('d-m-Y', strtotime($d)); }?></td>
                                                        ...
                                                        <td class="hidden-480">
                                                             ...
                                                             <?php if(($tsname=='admin') or ($tsname=='durgarao')or ($tsname=='sumanthpotluri')or ($tsname=='rajesh.p') ){ ?>
                                                            
                                                            <a href="knedit_wip.php?id=<?php echo $rs1['quet_num']; ?>&id1=<?php echo $r1['id'];?>">
                                                        <img src="images/edit.gif"></a>
                                                        
                                                        <?php }else{?>
                                                        <img src="images/edit.gif">
                                                        <?php }?>
                                                         <?php if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname==$ses) or ($tsname=='sumanthpotluri')or ($tsname=='rajesh.p')){ ?>

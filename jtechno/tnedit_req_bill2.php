...
<div class="row">
 ...
 <input type="hidden" name="ids" value="<?php echo $id?>">
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
										...
										id="inv_no"  class="form-control" value="<?php echo $r1['inv_num'];?>" required onkeyup="checkAvailability()">
	...
	$iname5 = ($iname5);
	 ...
	 $iname5 = ($img3);
			...
			print "</script>";
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="tnbill_list2.php"><button class="btn btn-danger" type="button" name="button" id="Close">

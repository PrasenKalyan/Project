...
$falt_desc=$_POST['falt_desc'];
	...
	$ac=mysqli_query($link,"update add_qot2 set quet_num='$qt_no' where id='$sno'");
...
$query = "INSERT INTO add_qot3 ( `desc1`, `hsn`, `gst`, `uom`, `qty`, `gst_amnt`, `rate`, `base_amt`,`date`,`id1`,item_id,serv_fee,cap,serv_amt,serv_code,serv_cap,brand,model) 
	VALUES 
 ('".addslashes($pname)."','$hsn','$gst','$uom','$qty','$gst_amnt','$price','$amnt','$date','$sno','$id','$serv_amt','$cap','$serv_amnt','$serv_code','$serv_codex','".addslashes($brand)."','".addslashes($model)."')";

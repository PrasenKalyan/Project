...
$objPHPExcel->getActiveSheet()->mergeCells('A8:K8');
 ...
 $objPHPExcel->getActiveSheet()->SetCellValue('G9', 'OD','UTF-8');
...
$y="select * from add_odqot where quet_num='$qtno'";
...
$y1="select * from add_odqot1 where id1='$id1'";

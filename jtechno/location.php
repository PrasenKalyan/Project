...
include'dbfiles/iqry_location.php';
?>
<!DOCTYPE html>
<html lang="en">
...
<td class="center">
                                                        ...
                                                        <td class="hidden-480"><?php echo $rs1['lname']; ?></td>
                                                        <td class="hidden-480"><?php echo $rs1['shippingto']; ?></td>
													   <td class="hidden-480"><?php echo $rs1['billingto']; ?></td>
                                                        <td>
                                                            <div class="hidden-sm hidden-xs action-buttons">
                                                               

                                                                
                                                                <a href="editlocation.php?id=<?php echo $rs1['id']; ?>"  class="data green"  > <i class="ace-icon fa fa-pencil bigger-130"></i></a>

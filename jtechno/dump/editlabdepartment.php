                            ...
                            <div class="col-xs-12">
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="" novalidate autocomplete="off">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="deptcode" readonly="readonly" name="deptcode" placeholder="Department Code" class="col-xs-10 col-sm-5" value="<?php echo $deptcode; ?>"/>
...
<script>
                    $(document).ready(function () {
                        ...
                        $("#success-alert").fadeTo(1000, 500).slideUp(500, function () {
                            ...
                            window.location.href='labdepartmt.php';  
                        });

                    ...
                    $next_increment = $data['Auto_increment'];
                                ...
                                <form class="form-horizontal" id="register-form" role="form" method="post" action=""  autocomplete="off">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" id="empcode" name="empcode" placeholder="Employee Code" class="form-control col-xs-10 col-sm-5" readonly value="<?php echo "EMP-".$next_increment; ?>" />
...
<span class="rq"><?php echo $errorDesignation ?></span>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control date-picker" value="<?php echo $jdate ?>" placeholder="dd/mm/yyyy" id="id-date-picker-1" name="jdate" type="text" data-date-format="dd/mm/yyyy" />
                                        ...
                                        <div class="col-sm-4">
                                            <select id="department" name="department"  class="form-control col-xs-10 col-sm-5" >
                                                ...
                                                while ($result = mysqli_fetch_array($qrye)) {
                                                    ?>
                                                    <option value="<?php echo $result['empid']; ?>"><?php echo $result['dept_name']; ?></option>
                                                <?php }
                                                ?>
                                            </select>
...
<span class="rq"><?php echo $errorDepartment ?></span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control date-picker" name="dob" value="<?php echo $dob; ?>" placeholder="dd/mm/yyyy" id="id-date-picker-1" type="text" data-date-format="dd/mm/yyyy" />
                                                    <span class="input-group-addon">
                                                        <i class="fa fa-calendar bigger-110"></i>
                                                    </span>
                                                </div>
...
<span class="rq"><?php echo $errorGender ?></span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" id="mobile" name="mobile" placeholder="Employee Mobile No" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" class="form-control col-xs-10 col-sm-5" value="<?php echo $mobile; ?>"/>

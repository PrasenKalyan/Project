...
include'dbfiles/irefdoctor.php';
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    $next_increment = $data['Auto_increment'];
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="" novalidate autocomplete="off">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="refcode" name="refcode" required placeholder="Ref Code" class="col-xs-10 col-sm-5" value="<?php echo "RDD-".$next_increment; ?>" readonly/> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="mobile" name="mobile" required placeholder="Mobile No" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" class="col-xs-10 col-sm-5" value="<?php echo $mobile; ?>" /> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="doctorshare" name="doctorshare" placeholder="Enter Doctor Share" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" class="col-xs-10 col-sm-5" value="<?php echo $doctorshare; ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="iplab" name="iplab" placeholder="Enter IP Lab Share" class="col-xs-10 col-sm-5" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" value="<?php echo $iplab; ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="oplab" name="oplab" placeholder="Enter Op Lab Share" class="col-xs-10 col-sm-5" value="<?php echo $oplab; ?>" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" />

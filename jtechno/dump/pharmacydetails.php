<?php include'dbconnection/check.php'; ?>
  ...
  include'dbfiles/pharmacy_update.php' ?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="col-xs-12">
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="" novalidate autocomplete="off">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Pharmacy Name </label>

                                        <div class="col-sm-8">
                                            <input type="text" id="labname" name="labname" placeholder="Pharmacy Name" class="col-xs-10 col-sm-5" value="<?php echo $labname; ?>"/>

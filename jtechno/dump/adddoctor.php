...
include'dbfiles/doctorinfo.php';
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <span class="rq"><?php echo $errorDesig ?></span>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control date-picker"  placeholder="dd/mm/yyyy" id="id-date-picker-1" name="joindate" type="text" data-date-format="dd/mm/yyyy"  value="<?php echo $joindate; ?>"/>
...
<span class="rq"><?php echo $errorGender ?></span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" id="mobile1" name="mobile1" placeholder="Doctor Mobile No" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" class="form-control col-xs-10 col-sm-5" value="<?php echo $mobile1; ?>"/>
...
<span class="rq"><?php echo $errorAadhar ?></span>
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" id="hshare" name="hshare" placeholder="Hospital Share" class="form-control col-xs-10 col-sm-5" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" value="<?php echo $hshare; ?>"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" id="phno" name="phno" placeholder="Phone Number" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" class="form-control col-xs-10 col-sm-5" value="<?php echo $phno; ?>"/>
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" id="dshare" name="dshare" placeholder="Doctor Share" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" class="form-control col-xs-10 col-sm-5" value="<?php echo $dshare; ?>"/>

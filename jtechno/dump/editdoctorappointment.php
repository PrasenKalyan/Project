...
include'dbfiles/uquery_doctorappointment.php';
?>
<!DOCTYPE html>
<html lang="en">
...
<?php echo $msg; ?>
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="" novalidate autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="mobile" maxlength="10" name="mobile" required placeholder="Mobile No" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" class="col-xs-10 col-sm-5" value="<?php echo $mobile; ?>" /> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="hidden" id="id" name="id" required placeholder="id" class="col-xs-10 col-sm-5" value="<?php echo $id1;?>"/>

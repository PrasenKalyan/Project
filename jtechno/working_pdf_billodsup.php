...
// Get the quotation number from the URL
$quet_num = $_GET['quet_num'];
...
<table border='1' style="width:100%" align="center"  cellpadding="0" cellspacing='0'>
        <thead>
            ...
            <img src="images/excel_logo.jpg" alt="Excel Logo" width="200%" height="100" style="display: block; margin: 0 auto;" /></th></tr>
        </thead>
        ...
        <tr>
									<td colspan="14">
										<table >
											...
											<tr><td><b>Vendor State&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  :</b></td><td><?php echo $state_code   ;?> STATE</td></tr><br/>
...
<tr><td colspan="14" style="text-align:center;font-size:18px;border:0px;"><b>Bill to Party</b><br /></td></tr>
<tr><td colspan="14">
        <tr>
									<td colspan="14">
										<table >
											<tr><td><b>Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></td><td><?php echo $r1['company_name'];?></td></tr><br/>
											<tr><td><b>Address&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :</b></td><td><?php echo  $r1['address'];?></td></tr><br/>
											<tr><td><b>State&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  :</b></td><td>	<?php   $st=$r1['state']; if($st=='AP'){ echo "ANDHRA PRADESH "; } else if($st=='TS'){ echo "TELANGANA STATE"; }else if($st=='KN'){ echo "KARNATAKA STATE"; }?> STATE</td></tr><br/>
											<tr><td><b>GSTIN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :</b></td><td><?php echo $r1['gst_in'];?></td></tr><br/>
										
										</table>
									</td>	
								</tr>
                                <tr><td colspan="14" style="text-align:center;font-size:18px;border:0px;"><b>Ship to Party</b><br /></td></tr>
<tr><td colspan="14">
        <tr>
									<td colspan="14">
										<table >
											<tr><td><b>Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></td><td><?php echo $ship_name;?></td></tr><br/>
											<tr><td><b>Address&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :</b></td><td><?php echo $store_name?>,<?php echo $addr1;?></td></tr><br/>
        ...
        <table border='1' style="width: 120%; max-width: 100%;" align="center" cellpadding="0" cellspacing='0'>
        <tr>

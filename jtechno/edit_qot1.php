                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="qot_list1.php"> Quotations List</a>
                            </li>
                            <li>
...
<div class="row">
 ...
 <form name="frm" method="post" action="qot_suc2.php">
...
$sql="select distinct store_code from dpr where state='TS' ";  // Query to collect records
...
?>
                                       ...
                                       <td align="right">PO Type</td><td align="left">
										...
										id="ro_date"  class="form-control" value="<?php echo $r['ro_date'];?>"></td>
                                        </tr>
										...
										id="po_date"  class="form-control" value="<?php echo $r['po_date'];?>"></td>
                                        </tr>
										
										
										 <tr><td align="right">Type of Work</td><td align="left">
										<input type="text" name="type_of_work" 
										...
										id="sub_type"  class="form-control" value="<?php echo $r['sub_type'];?>"></td>
                                        </tr>
									  ...
									  <tr><td align="right">Advance Amount1</td><td align="left">
										<input type="text" name="adv_amnt" onkeyup="myFunction()"
										id="adv_amnt"  class="form-control" value="<?php echo $r['adv_amnt'];?>"></td>	
                                        <td align="right">Advance Date1</td><td><input type="date" name="adv_date" 
										id="sub_type"  class="form-control" value="<?php $d1=$r['adv_date'];
										if($d1!='0000-00-00'){ echo $d1; } else { echo date('Y-m-d');}
										?>"></td>
                                        </tr>
										 <tr><td align="right">Select Ac Details 1</td><td align="left">
										<!--<select name="ac_det1" class="form-control">
										<option value="<?php echo $r['ac_det1'];?>"><?php echo $r['ac_det1'];?></option>
										<?php $sqc=mysqli_query($link,"select * from ac_det order by name");
										while($r4=mysqli_fetch_array($sqc)){?>
									...
									<input id=\"ac_det1\" list=\"city21\" class="form-control" name="ac_det1" value="<?php echo $str=$r['ac_det1'];?>"  >
<datalist id=\"city21\" >

<?php 
include_once('dbconnection/connection1.php');
$sql="select distinct name from ac_det order by name ";  // Query to collect records
$r1=mysqli_query($link,$sql) or die(mysql_error());
while ($row=mysqli_fetch_array($r1)) {
...
?>	
                                        ...
                                        <td align="right"></td><td></td>
										 ...
										 <tr><td align="right">Advance Amount 2</td><td align="left">
										<input type="text" name="adv_amnt1" 
										id="adv_amnt1" onkeyup="myFunction()" class="form-control" value="<?php echo $r['adv_amnt1'];?>"></td>	
                                        <td align="right">Advance Date2</td><td><input type="date" name="adv_date1" 
										id="sub_type"  class="form-control" value="<?php $d1=$r['adv_date1'];
										if($d1!='0000-00-00'){ echo $d1; } else { echo date('Y-m-d');}
										?>"></td>
                                        </tr>
										 <tr><td align="right">Select Ac Details 2</td><td align="left">
										
										<input id=\"ac_det2\" list=\"city22\" class="form-control" name="ac_det2" value="<?php echo $str=$r['ac_det2'];?>"  >
<datalist id=\"city22\" >
...
?>	
										...
										<!--<select name="ac_det2" class="form-control">
										<option value="<?php echo $r['ac_det2'];?>"><?php echo $r['ac_det2'];?></option>
										<?php $sqc=mysqli_query($link,"select * from ac_det order by name");
										while($r4=mysqli_fetch_array($sqc)){?>
                                        ...
                                        <td align="right"></td><td></td>
										 ...
										 <tr><td align="right">Advance Amount 3</td><td align="left">
										<input type="text" name="adv_amnt2" 
										id="adv_amnt2" onkeyup="myFunction()"  class="form-control" value="<?php echo $r['adv_amnt2'];?>"></td>	
                                        <td align="right">Advance Date 3</td><td><input type="date" name="adv_date2" 
										id="sub_type"  class="form-control" value="<?php $d1=$r['adv_date2'];
										if($d1!='0000-00-00'){ echo $d1; } else { echo date('Y-m-d');}
										?>"></td>
                                        </tr>
										 <tr><td align="right">Balance Amount</td><td align="left">
										<input type="text" name="bal" 
										id="bal"  class="form-control" value="<?php echo $r['bal'];?>"></td>	
                                        <td align="right">GST Type</td><td align="left">
									<select name="gst_type" class="form-control">
									    <option value="<?php echo $r['gst_type']?>"><?php echo $r['gst_type']?></option>
									    <option value="With GST">With GST</option>
									     <option value="Without GST">Without GST</option>
									</select></td>
                                        </tr>
										
										<tr><td align="right">Select Ac Details 3</td><td align="left">
										
										<input id=\"ac_det3\" list=\"city23\" class="form-control" name="ac_det3" value="<?php echo $str=$r['ac_det3'];?>"  >
<datalist id=\"city23\" >
...
?>	
										...
										<!--<select name="ac_det3" class="form-control">
										<option value="<?php echo $r['ac_det3'];?>"><?php echo $r['ac_det3'];?></option>
										<?php $sqc=mysqli_query($link,"select * from ac_det order by name");
										while($r4=mysqli_fetch_array($sqc)){?>
                                       ...
                                       <td align="right">Image1 </td><td>
										...
										<tr><td align="right">Image2</td><td align="left">
...
<button type="button" class='btn btn-danger delete'>-</button>
											...
											<?php   $id=count($_POST['id']);
											 $id1=$_GET['id'];
											 $aa="select * from add_qot3 where id1='$id1'";
												...
												while($rs1=mysqli_fetch_array($sq)){
                                                    ...
                                                    <td width="20px;">
													<a onclick="return confirm('Are you sure you want to delete this item?');" href='delete_line1.php?id=<?php echo $rs1['id']; ?>&id1=<?php echo $rs1['id1'];?>'><input type="button" class="btn btn-danger" value="Delete"></button>
							</a>
						...
						<input type="hidden" name="cap[]" value="<?php echo $rs1['cap']; ?>" style="width:60px;" class="txt20"  data-row="<?php echo $i?>"  id="cap<?php echo $i?>" />
														...
														<td>
						<input type="hidden" name="serv_amt[]" value="<?php echo $rs1['serv_amt']; ?>" style="width:60px;" class="txt21" data-row="<?php echo $i?>"    id="serv_amt<?php echo $i?>" />
														</td>
						...
						<input type="hidden" name="serv_code[]" value="<?php echo $rs1['serv_cap']; ?>" style="width:50px;" class="" id="serv_code<?php echo $i?>" />	   
									...
									?>
                                        <tr><td colspan="10" align="right"><strong>NET AMOUNT</strong></td>
										<td>

                        ...
                        <div class="row">
                            <div class="col-xs-6">
                               <div class="box box-info">
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="muploadproducts_suc.php" enctype="multipart/form-data" autocomplete="off">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                        ...
                                        <div>
											...
											if(isset($_POST['bsearch'])){
											 ...
											 $y="select * from mproducts where item_code like  '%$bsearch%' or item_desc like  '%$bsearch%' ";
...
<td class="center">
                                                        ...
                                                        <td class="hidden-480"><?php echo $rs1['item_category']; ?></td>
                                                         ...
                                                         <td><a href="edit_mprd.php?id=<?php echo $rs1['id'];?>"><img src="images/edit.gif"></a>
														  <a href="delete_mprd.php?id=<?php echo $rs1['id'];?>"><img src="images/Icon_Delete.png"></a>
														 </td>
...
echo "<li><a href='muploadproducts.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='muploadproducts.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>

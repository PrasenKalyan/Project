...
$sheet->setCellValue('A4', 'KARNATAKA TRACKER LIST');
...
while($row	=	$result->fetch_assoc()){
    ...
    $ds10 = "select sum(approve_amnt) as apamount,sum(transfer) as kltft,sum(gstamt) as klgst from knrequest_amnt where quet_num='$qno'";

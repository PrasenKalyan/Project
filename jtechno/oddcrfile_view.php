									...
									<input type="hidden" name="id1" 
										...
										if(isset($_POST['update'])){
											...
											$qt_no=$_POST['qt_no'];
												...
												$sq=mysqli_query($link,"update  odrequest_amnt set docr_status='$status' where id='$id'");
											
												$yt="update add_odqot set status='Not Required'  where quet_num='$qt_no'";
if($status=="approved"){
 $k=mysqli_query($link,$yt) or die(mysqli_error($link));   
			...
			print "self.location='odwork1.php';";
			print "</script>";
										}
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="odwork1.php"><button class="btn btn-danger" type="button" name="button" id="Close">

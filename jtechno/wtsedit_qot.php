                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="qot_list.php?state=<?php echo $state; ?>"><?php echo $state; ?> Quotations List</a>
                            </li>
                            <li>
...
<div class="row">
 ...
 <form name="frm" method="post" action="wtsqot_suc.php?state=<?php echo $state; ?>" enctype="multipart/form-data">
